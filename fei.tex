...
\part{序言}
\label{sec:orgff79d5d}

\chapter{简介}
\label{sec:org2e4b818}
...
\section{发展}
\label{sec:org8d0921f}

\begin{enumerate}
\item 演化
\label{sec:org851fcd8}
...
\section{比较}
\label{sec:orgad57a59}

\begin{enumerate}
\item 共同点
\label{sec:orgfdf5d6c}
...
\part{语音}
\label{sec:org8a962f1}

\chapter{字母}
\label{sec:org6ae1845}

\section{字母表}
\label{sec:org2736427}

\begin{enumerate}
\item Français
\label{sec:org0ecc4c6}
...
\chapter{发音}
\label{sec:org5acdb96}

\section{发音总表}
\label{sec:orgc18e678}
...
\section{发音规则}
\label{sec:orgab4740c}

\begin{enumerate}
\item Français
\label{sec:org2364bab}
...
\part{语法}
\label{sec:org328217c}

\chapter{名词}
\label{sec:org3e35885}

\section{名词}
\label{sec:org655d0db}

名词有性（阳性、阴性）、数（单数、复数）的变化，基本上不再有格的变化。

\begin{enumerate}
\item Français
\label{sec:org973c59f}

\item Español
\label{sec:org2bbb83f}

\item Italiano
\label{sec:orgb14e2ed}
...
\chapter{冠词}
\label{sec:orge74a40a}

\section{冠词}
\label{sec:org3e151b4}

冠词有性（阳性、阴性）、数（单数、复数）的变化，要和其限定的名词做性数配合。

\begin{enumerate}
\item Français
\label{sec:org6b1b4c3}
...
\chapter{代词}
\label{sec:org8614b9b}

\section{代词}
\label{sec:org8472c6c}

代词有性（阳性、阴性）、数（单数、复数）的变化。

\begin{enumerate}
\item Français
\label{sec:org6706928}

\item Español
\label{sec:orgf087102}

\item Italiano
\label{sec:org9ce87ea}
...
\chapter{数词}
\label{sec:orgc27615a}

\section{数词}
\label{sec:org7a6a162}

数词分基数词和序数词。基数词“1”需要和计数的名词的性一致。序数词要与被计数名词保持性数一致。

\begin{enumerate}
\item Français
\label{sec:orgaf98abb}

\item Español
\label{sec:org4aabac2}

\item Italiano
\label{sec:org1e488b3}
...
\chapter{动词}
\label{sec:org96afe03}

\section{动词}
\label{sec:org392ec23}

动词有时（现在时、将来时、过去时）、式（直陈式、命令式、虚拟式、条件式）、态（主动态、被动态）、分词（现在分词、过去分词）等各种变化。

\begin{enumerate}
\item Français
\label{sec:orgde98f87}

\item Español
\label{sec:orgb88d1fa}

\item Italiano
\label{sec:org1987373}
