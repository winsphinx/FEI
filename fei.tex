...
\part{序言}
\label{sec:org8fcfebb}

\chapter{简介}
\label{sec:org9cbb38a}
...
\caption{\label{fig:org01d340f}
分布图}
\end{figure}

\section{发展}
\label{sec:orgb10ac89}

\begin{enumerate}
\item 演化
\label{sec:org78be25d}
...
\caption{\label{fig:org7bc70e5}
演化图}
\end{figure}

\item 分支
\label{sec:org117e06e}
...
\section{比较}
\label{sec:orgdad2926}

\begin{enumerate}
\item 共同点
\label{sec:org9475b59}
...
\part{语音}
\label{sec:orgeb0a376}

\chapter{字母}
\label{sec:orgc03ddac}

\section{字母表}
\label{sec:org686d2bb}
\begin{enumerate}
\item Français
\label{sec:org93c0206}

\begin{longtabu} to 0.9\textwidth {XXX|XXX}
\caption{\label{tab:org1837387}
法语字母表}
\\
\toprule
字母 & 名称 & 读音 & 字母 & 名称 & 读音\\
...
\item Español
\label{sec:orge796bd6}

\begin{longtabu} to 0.9\textwidth {XXX|XXX}
\caption{\label{tab:org81dca1b}
西班牙语字母表}
\\
\toprule
字母 & 名称 & 读音 & 字母 & 名称 & 读音\\
...
\item Italiano
\label{sec:org68c38fa}

\begin{longtabu} to 0.9\textwidth {XXX|XXX}
\caption{\label{tab:org30379eb}
意大利语字母表}
\\
\toprule
字母 & 名称 & 读音 & 字母 & 名称 & 读音\\
...
\section{音符表}
\label{sec:org74df83a}

\begin{longtabu} to 0.9\textwidth {X|X|X|X}
\caption{\label{tab:org0c33235}
音符汇总表}
\\
\toprule
...
\chapter{发音}
\label{sec:org44e8db8}

\section{发音总表}
\label{sec:orgb9da472}

\begin{longtabu} to 0.9\textwidth {l|X|X|X}
\caption{\label{tab:org5f350a3}
元音汇总表}
\\
\toprule
音标 & 法语 & 西班牙语 & 意大利语\\
...
\section{发音规则}
\label{sec:org1fc086f}

\begin{enumerate}
\item Français
\label{sec:org495477b}

\begin{longtabu} to 0.9\textwidth {X|l|X}
\caption{\label{tab:org3a1dade}
法语元音表}
\\
\toprule
字母组合 & 读音 & 例词\\
...
\item Español
\label{sec:orgb825526}

\begin{longtabu} to 0.9\textwidth {X|l|X}
\caption{\label{tab:org8ef66ce}
西班牙语元音表}
\\
\toprule
字母组合 & 读音 & 例词\\
...
\item Italiano
\label{sec:org96069f7}

\begin{longtabu} to 0.9\textwidth {X|l|X}
\caption{\label{tab:org33bea3e}
意大利语元音表}
\\
\toprule
字母组合 & 读音 & 例词\\
...
\part{语法}
\label{sec:orgdedcd54}

\chapter{名词}
\label{sec:org8fafb28}

\section{概述}
\label{sec:org53dd7bc}

\begin{enumerate}
\item Français
\label{sec:org93a5ed6}

\item Español
\label{sec:orgb35ace6}

\item Italiano
\label{sec:orge97bbda}
\end{enumerate}

\chapter{冠词}
\label{sec:orgbdc4c99}

\section{概述}
\label{sec:orgb185ea0}

\begin{enumerate}
\item Français
\label{sec:org3c9baa7}

\item Español
\label{sec:org29ed1d7}

\item Italiano
\label{sec:org430d242}
\end{enumerate}

\chapter{代词}
\label{sec:org9760b18}

\section{人称代词}
\label{sec:org9abf1ce}

\begin{enumerate}
\item Français
\label{sec:orge43585f}

\item Español
\label{sec:org23f80af}

\item Italiano
\label{sec:org9f1a424}
\end{enumerate}

\section{主有代词}
\label{sec:org7fe2837}

\begin{enumerate}
\item Français
\label{sec:org8d5436c}

\item Español
\label{sec:org13d3866}

\item Italiano
\label{sec:org4b88dce}
\end{enumerate}

\section{指示代词}
\label{sec:org2482e2d}

\begin{enumerate}
\item Français
\label{sec:org729cc8a}

\item Español
\label{sec:org13543bd}

\item Italiano
\label{sec:org4266cb9}
\end{enumerate}

\chapter{形容词}
\label{sec:orgd2ffa9d}

\section{主有形容词}
\label{sec:org9b64437}

\begin{enumerate}
\item Français
\label{sec:orge1beee1}

\item Español
\label{sec:orgcb43739}

\item Italiano
\label{sec:org15a555c}
\end{enumerate}

\section{指示形容词}
\label{sec:orge64f362}

\begin{enumerate}
\item Français
\label{sec:org3705c8f}

\item Español
\label{sec:org5f04fb6}

\item Italiano
\label{sec:orge8bc1f2}
\end{enumerate}

\chapter{数词}
\label{sec:orgd332fba}

\section{概述}
\label{sec:org6d134d6}

\begin{enumerate}
\item Français
\label{sec:orgda9f2b6}

\item Español
\label{sec:org46ee6d2}

\item Italiano
\label{sec:org9ebd2f8}
\end{enumerate}

\chapter{动词}
\label{sec:org5bd1a01}

\section{概述}
\label{sec:org4a11b99}

\begin{enumerate}
\item Français
\label{sec:org768ba2a}

\item Español
\label{sec:org7066d5e}

\item Italiano
\label{sec:org898ceab}
\end{enumerate}

\chapter{副词}
\label{sec:org8ef1c65}

\section{概述}
\label{sec:org5ba4172}

\begin{enumerate}
\item Français
\label{sec:org44ff1e2}

\item Español
\label{sec:org21d7b97}

\item Italiano
\label{sec:org72f487f}
\end{enumerate}

\chapter{介词}
\label{sec:org407b0a3}

\section{概述}
\label{sec:org0b5b39f}

\begin{enumerate}
\item Français
\label{sec:org9f195b9}

\item Español
\label{sec:org2af4fc3}

\item Italiano
\label{sec:org29c2451}
\end{enumerate}

\part{句法}
\label{sec:orgb085b76}

\newpage
\part{附录}
\label{sec:orge5ebb1f}
