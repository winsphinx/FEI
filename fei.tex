...
\part{序言}
\label{sec:orgedb01fc}

\chapter{简介}
\label{sec:orge8b56a5}
...
\section{发展}
\label{sec:org39aa8c0}

\begin{enumerate}
\item 演化
\label{sec:org5cc8a1b}
...
\section{比较}
\label{sec:orgca376d3}

\begin{enumerate}
\item 共同点
\label{sec:org6804856}
...
\part{语音}
\label{sec:orgaaa6ef4}

\chapter{字母}
\label{sec:orgde6e197}

\section{字母表}
\label{sec:org3fd8a76}
\begin{enumerate}
\item Français
\label{sec:org2c31eae}
...
\chapter{发音}
\label{sec:org274ad03}

\section{发音总表}
\label{sec:org3daeb0c}
...
\section{发音规则}
\label{sec:org8654e3f}

\begin{enumerate}
\item Français
\label{sec:org9507079}
...
\part{语法}
\label{sec:org86d1e3d}

\chapter{名词}
\label{sec:org7d15b2b}

\section{概述}
\label{sec:org652b1cf}

\begin{enumerate}
\item Français
\label{sec:orgc613401}

\item Español
\label{sec:orgec29fbb}

\item Italiano
\label{sec:orgbf92c23}
\end{enumerate}

\chapter{冠词}
\label{sec:org4c98fd7}

\section{概述}
\label{sec:org8abd637}

\begin{enumerate}
\item Français
\label{sec:org5f1f975}

\item Español
\label{sec:org4fc7b44}

\item Italiano
\label{sec:org6c69bc5}
\end{enumerate}

\chapter{代词}
\label{sec:org0a54faf}

\section{人称代词}
\label{sec:org67cf9cf}

\begin{enumerate}
\item Français
\label{sec:orgd0b648c}

\item Español
\label{sec:org1dec737}

\item Italiano
\label{sec:org59eb6e9}
\end{enumerate}

\section{主有代词}
\label{sec:org054d6ec}

\begin{enumerate}
\item Français
\label{sec:orgfe348c9}

\item Español
\label{sec:org52208d9}

\item Italiano
\label{sec:orgfdf739c}
\end{enumerate}

\section{指示代词}
\label{sec:org612320f}

\begin{enumerate}
\item Français
\label{sec:orge402785}

\item Español
\label{sec:org407b6af}

\item Italiano
\label{sec:orga0e8656}
\end{enumerate}

\chapter{形容词}
\label{sec:org519b4d3}

\section{主有形容词}
\label{sec:orgb23225d}

\begin{enumerate}
\item Français
\label{sec:org140319e}

\item Español
\label{sec:org5191036}

\item Italiano
\label{sec:org6aedc41}
\end{enumerate}

\section{指示形容词}
\label{sec:orga50248e}

\begin{enumerate}
\item Français
\label{sec:orga750f49}

\item Español
\label{sec:orgf4753f2}

\item Italiano
\label{sec:org582b86d}
\end{enumerate}

\chapter{数词}
\label{sec:org57a4b57}

\section{概述}
\label{sec:orge5039c6}

\begin{enumerate}
\item Français
\label{sec:org376141b}

\item Español
\label{sec:orgb2690ed}

\item Italiano
\label{sec:org9acddf7}
\end{enumerate}

\chapter{动词}
\label{sec:orgff242f8}

\section{概述}
\label{sec:orgd544ac3}

\begin{enumerate}
\item Français
\label{sec:orgd800504}

\item Español
\label{sec:org8032bd2}

\item Italiano
\label{sec:org54ab261}
\end{enumerate}

\chapter{副词}
\label{sec:org9a13828}

\section{概述}
\label{sec:orgd61abae}

\begin{enumerate}
\item Français
\label{sec:org3f6f6fc}

\item Español
\label{sec:org0c5a685}

\item Italiano
\label{sec:org0bb141c}
\end{enumerate}

\chapter{介词}
\label{sec:org161a8c0}

\section{概述}
\label{sec:orgad84acc}

\begin{enumerate}
\item Français
\label{sec:org1f4f00e}

\item Español
\label{sec:org8c9967b}

\item Italiano
\label{sec:orge7a2771}
\end{enumerate}

\part{句法}
\label{sec:orgaae43f7}

\newpage
\part{附录}
\label{sec:org0093e56}
