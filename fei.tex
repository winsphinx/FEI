...
\part{序言}
\label{sec:org3a62b0d}

\chapter{简介}
\label{sec:org11b528c}
...
\section{发展}
\label{sec:orgdc14a91}

\begin{enumerate}
\item 演化
\label{sec:orgf5258d2}
...
\section{比较}
\label{sec:orgb0b236b}

\begin{enumerate}
\item 共同点
\label{sec:org4907c69}
...
\part{语音}
\label{sec:org323f9d0}

\chapter{字母}
\label{sec:orgae3d78c}

\section{字母表}
\label{sec:orgb17afdc}
\begin{enumerate}
\item Français
\label{sec:org44c6f9f}
...
\chapter{发音}
\label{sec:orgcc16b1b}

\section{发音总表}
\label{sec:org06190e0}
...
\section{发音规则}
\label{sec:orgda55913}

\begin{enumerate}
\item Français
\label{sec:org7d97160}
