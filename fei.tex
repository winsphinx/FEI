...
\part{序言}
\label{sec:org8d8b4e1}

\chapter{简介}
\label{sec:orgd2908fb}
...
\caption{\label{fig:orge43f1c1}
分布图}
\end{figure}

\section{发展}
\label{sec:orgd160b13}

\begin{enumerate}
\item 演化
\label{sec:orgd5f2cf9}
...
\caption{\label{fig:org06bd261}
演化图}
\end{figure}

\item 分支
\label{sec:orgea10072}
...
\section{比较}
\label{sec:orgf39bb9a}

\begin{enumerate}
\item 共同点
\label{sec:orgad5526a}
...
\part{语音}
\label{sec:orge6514a3}

\chapter{字母}
\label{sec:org7272eea}

\section{字母表}
\label{sec:orga8556a8}
\begin{enumerate}
\item Français
\label{sec:org6b2f82e}

\begin{longtabu} to 0.9\textwidth {XXX|XXX}
\caption{\label{tab:org1c05a06}
法语字母表}
\\
\toprule
字母 & 名称 & 读音 & 字母 & 名称 & 读音\\
...
\item Español
\label{sec:orgcbaebba}

\begin{longtabu} to 0.9\textwidth {XXX|XXX}
\caption{\label{tab:org48a0a97}
西班牙语字母表}
\\
\toprule
字母 & 名称 & 读音 & 字母 & 名称 & 读音\\
...
\item Italiano
\label{sec:org7ed1d72}

\begin{longtabu} to 0.9\textwidth {XXX|XXX}
\caption{\label{tab:org86808d1}
意大利语字母表}
\\
\toprule
字母 & 名称 & 读音 & 字母 & 名称 & 读音\\
...
\section{音符表}
\label{sec:org3883069}

\begin{longtabu} to 0.9\textwidth {X|X|X|X}
\caption{\label{tab:orgd041d35}
音符汇总表}
\\
\toprule
...
\chapter{发音}
\label{sec:orgacd6676}

\section{发音总表}
\label{sec:org0e7eb38}

\begin{longtabu} to 0.9\textwidth {l|X|X|X}
\caption{\label{tab:org2a79218}
元音汇总表}
\\
\toprule
音标 & 法语 & 西班牙语 & 意大利语\\
...
\section{发音规则}
\label{sec:org3cf62bc}

\begin{enumerate}
\item Français
\label{sec:org00ac9eb}

\begin{longtabu} to 0.9\textwidth {X|l|X}
\caption{\label{tab:org22a875e}
法语元音表}
\\
\toprule
字母组合 & 读音 & 例词\\
...
\item Español
\label{sec:orga1e1251}

\begin{longtabu} to 0.9\textwidth {X|l|X}
\caption{\label{tab:org877cbe2}
西班牙语元音表}
\\
\toprule
字母组合 & 读音 & 例词\\
...
\item Italiano
\label{sec:orgbd6a99c}

\begin{longtabu} to 0.9\textwidth {X|l|X}
\caption{\label{tab:orgc108fe4}
意大利语元音表}
\\
\toprule
字母组合 & 读音 & 例词\\
...
\part{语法}
\label{sec:orga917401}

\chapter{名词}
\label{sec:orgca237df}

\section{概述}
\label{sec:orgc5836f4}

\begin{enumerate}
\item Français
\label{sec:orgcd1843d}

\item Español
\label{sec:org87ee7d4}

\item Italiano
\label{sec:org1cd51d2}
\end{enumerate}

\chapter{冠词}
\label{sec:org8f93138}

\section{概述}
\label{sec:org073e7fb}

\begin{enumerate}
\item Français
\label{sec:orgf0f81c8}

\item Español
\label{sec:org8437b9a}

\item Italiano
\label{sec:org7459ed9}
\end{enumerate}

\chapter{代词}
\label{sec:org273129e}

\section{人称代词}
\label{sec:org06447f0}

\begin{enumerate}
\item Français
\label{sec:orgb61d948}

\item Español
\label{sec:org17c0be6}

\item Italiano
\label{sec:org72cc3b1}
\end{enumerate}

\section{主有代词}
\label{sec:orga93432e}

\begin{enumerate}
\item Français
\label{sec:org3b3d255}

\item Español
\label{sec:org454926a}

\item Italiano
\label{sec:org9a49adb}
\end{enumerate}

\section{指示代词}
\label{sec:org616d1f6}

\begin{enumerate}
\item Français
\label{sec:org2df4b44}

\item Español
\label{sec:org4740d2b}

\item Italiano
\label{sec:org638744b}
\end{enumerate}

\chapter{形容词}
\label{sec:org3d2f42f}

\section{主有形容词}
\label{sec:org6adefdf}

\begin{enumerate}
\item Français
\label{sec:orgf67c174}

\item Español
\label{sec:org1768bfd}

\item Italiano
\label{sec:org91dcda0}
\end{enumerate}

\section{指示形容词}
\label{sec:org8bafae7}

\begin{enumerate}
\item Français
\label{sec:org507df84}

\item Español
\label{sec:org3cee01f}

\item Italiano
\label{sec:orgdaa1232}
\end{enumerate}

\chapter{数词}
\label{sec:orgd7c2491}

\section{概述}
\label{sec:org7cd19ef}

\begin{enumerate}
\item Français
\label{sec:orgdfad8e9}

\item Español
\label{sec:org2ab257a}

\item Italiano
\label{sec:orgbbcf979}
\end{enumerate}

\chapter{动词}
\label{sec:org5872463}

\section{概述}
\label{sec:orgfaf76fb}

\begin{enumerate}
\item Français
\label{sec:org6d74fe8}

\item Español
\label{sec:org7e5585b}

\item Italiano
\label{sec:orgcd7175a}
\end{enumerate}

\chapter{副词}
\label{sec:orgf6d789d}

\section{概述}
\label{sec:org6940948}

\begin{enumerate}
\item Français
\label{sec:org767e62a}

\item Español
\label{sec:org838a25f}

\item Italiano
\label{sec:orgffb223b}
\end{enumerate}

\chapter{介词}
\label{sec:orgc2f53a9}

\section{概述}
\label{sec:org9548df2}

\begin{enumerate}
\item Français
\label{sec:org42021c4}

\item Español
\label{sec:orgcebac67}

\item Italiano
\label{sec:orga03c540}
\end{enumerate}

\part{句法}
\label{sec:org8ec3068}

\newpage
\part{附录}
\label{sec:org1a51fb5}
