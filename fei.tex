...
\part{序言}
\label{sec:orga49e52c}

\chapter{简介}
\label{sec:org6437540}
...
\section{发展}
\label{sec:orgf7433fc}

\begin{enumerate}
\item 演化
\label{sec:org0c630d5}
...
\section{比较}
\label{sec:org5632d43}

\begin{enumerate}
\item 共同点
\label{sec:org4fbb723}
...
\part{语音}
\label{sec:orgdd60b74}

\chapter{字母}
\label{sec:org5dc4035}

\section{字母表}
\label{sec:orgcb4ef81}
\begin{enumerate}
\item Français
\label{sec:org5fa2a51}
...
\chapter{发音}
\label{sec:org6fe84b0}

\section{发音总表}
\label{sec:orgbfa152e}
...
\section{发音规则}
\label{sec:org6f7a6f5}

\begin{enumerate}
\item Français
\label{sec:org8b96362}
...
\part{语法}
\label{sec:org7166a64}

\chapter{名词}
\label{sec:orgd8eb01c}

\section{概述}
\label{sec:org7edd9d5}

\begin{enumerate}
\item Français
\label{sec:org2ef8dc1}

\item Español
\label{sec:orgc2aab66}

\item Italiano
\label{sec:org1e3025a}
...
\chapter{冠词}
\label{sec:orgd9efadb}

\section{概述}
\label{sec:org4649393}

\begin{enumerate}
\item Français
\label{sec:org727decd}
...
\chapter{代词}
\label{sec:org450bf36}

\section{人称代词}
\label{sec:org178ca97}

\begin{enumerate}
\item Français
\label{sec:org9647164}

\item Español
\label{sec:org179ef3e}

\item Italiano
\label{sec:org7c1d6b3}
\begin{longtabu} to 0.9\textwidth {l|X|X|X|X|X|X}
\caption{意大利语人称代词表}
\\
\toprule
...
\section{物主代词}
\label{sec:org50e9467}

\begin{enumerate}
\item Français
\label{sec:orgc686ccd}

\item Español
\label{sec:orgef33b6b}

\item Italiano
\label{sec:orgdb008b0}
...
\section{指示代词}
\label{sec:org12b068d}

\begin{enumerate}
\item Français
\label{sec:orgf0005fa}

\item Español
\label{sec:org895125d}

\item Italiano
\label{sec:orgaa7e7a0}
...
\section{疑问代词}
\label{sec:org111d3c2}

\begin{enumerate}
\item Français
\label{sec:org03bfe48}

\item Español
\label{sec:org88c4cf0}

\item Italiano
\label{sec:orge0cef85}
...
\section{关系代词}
\label{sec:org09c7eb7}

\begin{enumerate}
\item Français
\label{sec:orga3a8da5}

\item Español
\label{sec:org9087c7c}

\item Italiano
\label{sec:org3654266}
...
\chapter{形容词}
\label{sec:orgcb7d053}

\section{形容词}
\label{sec:org9ef1098}

\begin{enumerate}
\item Français
\label{sec:org4a4e659}

\item Español
\label{sec:orgb0b0b5b}

\item Italiano
\label{sec:orgbffe6e9}
...
\section{物主形容词}
\label{sec:orgc19aab7}

\begin{enumerate}
\item Français
\label{sec:org3b016c0}

\item Español
\label{sec:orge04eaa3}

\item Italiano
\label{sec:org1d97ab5}
...
\section{指示形容词}
\label{sec:org69ea49e}

\begin{enumerate}
\item Français
\label{sec:orgfe49b21}

\item Español
\label{sec:orga10a6dc}

\item Italiano
\label{sec:org8bc3d4d}
...
\section{疑问形容词}
\label{sec:orgd6f813e}

\begin{enumerate}
\item Français
\label{sec:org21353f5}

\item Español
\label{sec:org0e44deb}

\item Italiano
\label{sec:org2b75ec0}
...
\chapter{数词}
\label{sec:orgd72871f}

\section{概述}
\label{sec:orgfed8b4d}

\begin{enumerate}
\item Français
\label{sec:org5748f7c}

\item Español
\label{sec:orgd462ba8}

\item Italiano
\label{sec:org53aa257}
...
\chapter{动词}
\label{sec:org6875a34}

\section{概述}
\label{sec:org2ad9d8f}

\begin{enumerate}
\item Français
\label{sec:orgeec6cae}

\item Español
\label{sec:orgaea4d2a}

\item Italiano
\label{sec:org562ac7b}
...
\chapter{副词}
\label{sec:org53df11b}

\section{概述}
\label{sec:org8f5c8b7}

\begin{enumerate}
\item Français
\label{sec:org45a32de}

\item Español
\label{sec:org538172b}

\item Italiano
\label{sec:orgc2ee840}
\end{enumerate}

\chapter{介词}
\label{sec:orga993ae0}

\section{概述}
\label{sec:orgb5de3f5}

\begin{enumerate}
\item Français
\label{sec:org6115240}

\item Español
\label{sec:org56d9996}

\item Italiano
\label{sec:orgf714255}
\end{enumerate}

\part{句法}
\label{sec:orgce61d69}

\newpage
\part{附录}
\label{sec:org17ed25b}
