...
\part{序言}
\label{sec:orgcddc9b9}

\chapter{简介}
\label{sec:orga05fe10}
...
\section{发展}
\label{sec:org361060a}

\begin{enumerate}
\item 演化
\label{sec:orgd24af65}
...
\section{比较}
\label{sec:org21cb32f}

\begin{enumerate}
\item 共同点
\label{sec:orgf4d68c5}
...
\part{语音}
\label{sec:org56710a6}

\chapter{字母}
\label{sec:org17f7d45}

\section{字母表}
\label{sec:org6519d0d}
\begin{enumerate}
\item Français
\label{sec:org18877e0}
...
\chapter{发音}
\label{sec:orga4427c1}

\section{发音总表}
\label{sec:org11844d5}
...
\section{发音规则}
\label{sec:orgfa4811d}

\begin{enumerate}
\item Français
\label{sec:org53239aa}
...
\part{语法}
\label{sec:orgb59a507}

\chapter{名词}
\label{sec:org68a0a97}

\section{概述}
\label{sec:org5179c5d}

\begin{enumerate}
\item Français
\label{sec:orgea4493d}

\item Español
\label{sec:org6f71b26}

\item Italiano
\label{sec:org81baa9e}
...
\chapter{冠词}
\label{sec:orgdceeef7}

\section{概述}
\label{sec:org1df18d7}

\begin{enumerate}
\item Français
\label{sec:org5eb13b9}
...
\begin{enumerate}
\item Français
\label{sec:org64ff309}

\item Español
\label{sec:orgb880d78}

\item Italiano
\label{sec:orgda50959}
\begin{longtabu} to 0.9\textwidth {l|X|X|X|X|X|X}
\caption{意大利语人称代词表}
\\
\toprule
...
\section{物主代词}
\label{sec:org926c6a6}

\begin{enumerate}
\item Français
\label{sec:orgc42d5b0}

\item Español
\label{sec:org97bd989}

\item Italiano
\label{sec:orge151cea}
...
\section{指示代词}
\label{sec:org53a95e5}

\begin{enumerate}
\item Français
\label{sec:org2b162aa}

\item Español
\label{sec:org42f198c}

\item Italiano
\label{sec:org425fc38}
...
\section{疑问代词}
\label{sec:org7b8428c}

\begin{enumerate}
\item Français
\label{sec:orgbc777d8}

\item Español
\label{sec:org5311360}

\item Italiano
\label{sec:orga428c73}
...
\section{关系代词}
\label{sec:org84fdacf}

\begin{enumerate}
\item Français
\label{sec:orgaf15f9a}

\item Español
\label{sec:org6bccf0d}

\item Italiano
\label{sec:org146d965}
...
\chapter{形容词}
\label{sec:org4193fd4}

\section{形容词}
\label{sec:org544f897}

\begin{enumerate}
\item Français
\label{sec:orgacc60be}

\item Español
\label{sec:org671ce2f}

\item Italiano
\label{sec:orgfc11ad9}
...
\section{物主形容词}
\label{sec:orgee8ac5e}

\begin{enumerate}
\item Français
\label{sec:orgfd33fe8}

\item Español
\label{sec:org45f259f}

\item Italiano
\label{sec:orged0c146}
...
\section{指示形容词}
\label{sec:org77ce973}

\begin{enumerate}
\item Français
\label{sec:org0e128a0}

\item Español
\label{sec:org8148b94}

\item Italiano
\label{sec:orgfda8d04}
...
\section{疑问形容词}
\label{sec:orgdfd3dfc}

\begin{enumerate}
\item Français
\label{sec:org0407199}

\item Español
\label{sec:org1afebd2}

\item Italiano
\label{sec:orgbf14a3f}
...
\chapter{数词}
\label{sec:orgf004963}

\section{概述}
\label{sec:orgd3e5bbb}

\begin{enumerate}
\item Français
\label{sec:org301a397}

\item Español
\label{sec:org4201a9e}

\item Italiano
\label{sec:org18273bb}
...
\chapter{动词}
\label{sec:orgc1b0f79}

\section{概述}
\label{sec:org2350291}

\begin{enumerate}
\item Français
\label{sec:org01e9170}

\item Español
\label{sec:orgda05628}

\item Italiano
\label{sec:orgdf93d57}
...
\chapter{副词}
\label{sec:orgd6896a2}

\section{概述}
\label{sec:org0d2b6ab}

\begin{enumerate}
\item Français
\label{sec:org8471264}

\item Español
\label{sec:org484a229}

\item Italiano
\label{sec:org7137aab}
\end{enumerate}

\chapter{介词}
\label{sec:org4c91238}

\section{概述}
\label{sec:org11bf222}

\begin{enumerate}
\item Français
\label{sec:orgfd89a9d}

\item Español
\label{sec:orgd865559}

\item Italiano
\label{sec:org5fed211}
\end{enumerate}

\part{句法}
\label{sec:org06d95e8}

\newpage
\part{附录}
\label{sec:org8b33c1b}
