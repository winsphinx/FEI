...
\part{序言}
\label{sec:org5e702fc}

\chapter{简介}
\label{sec:org1d1cb9b}
...
\section{发展}
\label{sec:org43ab1d5}

\begin{enumerate}
\item 演化
\label{sec:org8d12709}
...
\section{比较}
\label{sec:orgdb1e188}

\begin{enumerate}
\item 共同点
\label{sec:org06009dd}
...
\part{语音}
\label{sec:orgeba1045}

\chapter{字母}
\label{sec:org37ff84c}

\section{字母表}
\label{sec:org3c44546}
\begin{enumerate}
\item Français
\label{sec:org3c2f94e}
...
\chapter{发音}
\label{sec:org612b37a}

\section{发音总表}
\label{sec:orgc64eb2a}
...
\section{发音规则}
\label{sec:orgbf26c12}

\begin{enumerate}
\item Français
\label{sec:org0802ce2}
...
\part{语法}
\label{sec:orgaac98a2}

\chapter{名词}
\label{sec:org9ab0783}

\section{概述}
\label{sec:org4e083c7}

\begin{enumerate}
\item Français
\label{sec:org7541dc0}

\item Español
\label{sec:orgdeedad8}

\item Italiano
\label{sec:orgcc8fefc}
...
\chapter{冠词}
\label{sec:org730173f}

\section{概述}
\label{sec:org9ecc7b6}

\begin{enumerate}
\item Français
\label{sec:org31a806c}
...
\chapter{代词}
\label{sec:orgb7926f4}

\section{人称代词}
\label{sec:orgd69a4a4}

\begin{enumerate}
\item Français
\label{sec:orgdf2bf9a}

\item Español
\label{sec:org922fb47}

\item Italiano
\label{sec:org4ee0733}
\begin{longtabu} to 0.9\textwidth {l|X|X|X|X|X|X}
\caption{意大利语人称代词表}
\\
\toprule
...
\section{物主代词}
\label{sec:org022e62b}

\begin{enumerate}
\item Français
\label{sec:orgf98e85d}

\item Español
\label{sec:org23d2f59}

\item Italiano
\label{sec:orge8ad427}
...
\section{指示代词}
\label{sec:orge90411d}

\begin{enumerate}
\item Français
\label{sec:org68a56c7}

\item Español
\label{sec:org9990069}

\item Italiano
\label{sec:org41db809}
...
\section{疑问代词}
\label{sec:org9d70591}

\begin{enumerate}
\item Français
\label{sec:orgf95999c}

\item Español
\label{sec:org7ef9746}

\item Italiano
\label{sec:orgab40417}
...
\section{关系代词}
\label{sec:org8036b3f}

\begin{enumerate}
\item Français
\label{sec:org9340e32}

\item Español
\label{sec:orga7f6d6e}

\item Italiano
\label{sec:org1b4a662}
...
\chapter{形容词}
\label{sec:orgf1a2269}

\section{形容词概述}
\label{sec:org8e87d00}

\begin{enumerate}
\item Français
\label{sec:org4ce27f8}

\item Español
\label{sec:orgadd9f4b}

\item Italiano
\label{sec:org835fbb6}
...
\section{物主形容词}
\label{sec:org4906980}

\begin{enumerate}
\item Français
\label{sec:orgf1de4be}

\item Español
\label{sec:orgcd8db04}

\item Italiano
\label{sec:org0b7a7b6}
...
\section{指示形容词}
\label{sec:orgdfe6b78}

\begin{enumerate}
\item Français
\label{sec:orgb887ef1}

\item Español
\label{sec:orgade3a70}

\item Italiano
\label{sec:orge41a546}
...
\section{疑问形容词}
\label{sec:org7b89009}

\begin{enumerate}
\item Français
\label{sec:orga0f1d54}

\item Español
\label{sec:orgb84690d}

\item Italiano
\label{sec:orgef8ed1d}
...
\chapter{数词}
\label{sec:orga67ace3}

\section{概述}
\label{sec:org8d2874e}

\begin{enumerate}
\item Français
\label{sec:orgd8991a4}

\item Español
\label{sec:orgfa65aed}

\item Italiano
\label{sec:org748ec98}
...
\chapter{动词}
\label{sec:orgaa80d4a}

\section{时式}
\label{sec:org7d515ce}

\begin{enumerate}
\item Français
\label{sec:orgbd7fb2c}

\item Español
\label{sec:orgf84e8a1}

\item Italiano
\label{sec:org371ee00}
...
\endfoot
\endlastfoot
直陈式 & \hyperref[意大利语直陈式远愈过去时变位表]{远愈过去时} <== \hyperref[意大利语直陈式远过去时变位表]{远过去时} <== \hyperref[意大利语直陈式近愈过去时变位表]{近愈过去时} <== \hyperref[意大利语直陈式未完成过去时变位表]{未完成过去时} & \hyperref[意大利语直陈式近过去时变位表]{近过去时} <== \hyperref[意大利语直陈式现在时变位表]{现在时} & \hyperref[意大利语直陈式先将来时变位表]{先将来时} <== \hyperref[意大利语直陈式简单将来时变位表]{简单将来时}\\
命令式 &  & 现在时 & \\
条件式 &  &  & \\
虚拟式 &  &  & \\
\bottomrule
...
\begin{itemize}
\item 直陈式未完成过去时表示过去持续、经常、重复发生的动作或状态；或是用在文学描述中。
\item 一些不规则动词：
\begin{center}
\begin{tabular}{lllllll}
 & io & tu & lui/lei & noi & voi & loro\\
...
\endfoot
\endlastfoot
avere 的未完成过去时 + 过去分词 & avevo & avevi & aveva & avevamo & avevate & avevano\\
essere 的未完成过去时 + 过去分词 & ero & eri & era & eravamo & eravate & erano\\
\bottomrule
\end{longtabu}
...
\section{形式}
\label{sec:org4e8465a}

\begin{enumerate}
\item Français
\label{sec:orgd16fd6f}

\item Español
\label{sec:orgbdf201d}

\item Italiano
\label{sec:org0bcf52e}
...
\chapter{副词}
\label{sec:org63fa791}

\section{概述}
\label{sec:org2c4d455}

\begin{enumerate}
\item Français
\label{sec:org696a339}

\item Español
\label{sec:org9897ced}

\item Italiano
\label{sec:org4b9f99b}
\end{enumerate}

\chapter{介词}
\label{sec:orgccba750}

\section{概述}
\label{sec:orgd146764}

\begin{enumerate}
\item Français
\label{sec:org87c6a2c}

\item Español
\label{sec:org16562cc}

\item Italiano
\label{sec:orged6f0fd}
\end{enumerate}

\part{句法}
\label{sec:org37a4eb7}

\newpage
\part{附录}
\label{sec:orgf40786d}
