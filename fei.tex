...
\part{序言}
\label{sec:orgd8bb4ad}

\chapter{简介}
\label{sec:org8d279e8}
...
\section{发展}
\label{sec:org81d6341}

\begin{enumerate}
\item 演化
\label{sec:org7de2166}
...
\section{比较}
\label{sec:orgf295d29}

\begin{enumerate}
\item 共同点
\label{sec:org524d348}
...
\part{语音}
\label{sec:org5aa7f71}

\chapter{字母}
\label{sec:org44939d8}

\section{字母表}
\label{sec:orgf744cf4}
\begin{enumerate}
\item Français
\label{sec:orgae5944e}
...
\chapter{发音}
\label{sec:org9731a9f}

\section{发音总表}
\label{sec:org4286f18}
...
\section{发音规则}
\label{sec:org8903db5}

\begin{enumerate}
\item Français
\label{sec:org138fbb7}
...
\part{语法}
\label{sec:org90ddb85}

\chapter{名词}
\label{sec:org178eedc}

\section{概述}
\label{sec:org9e89dd9}

\begin{enumerate}
\item Français
\label{sec:orgb54a341}

\item Español
\label{sec:org27e765f}

\item Italiano
\label{sec:orgf36e5d9}
...
\chapter{冠词}
\label{sec:orgd2ebd39}

\section{概述}
\label{sec:org5e6c0ee}

\begin{enumerate}
\item Français
\label{sec:orgca6d76c}
...
\chapter{代词}
\label{sec:orgf03715f}

\section{人称代词}
\label{sec:org0133301}

\begin{enumerate}
\item Français
\label{sec:org48ef7fb}

\item Español
\label{sec:org9cbefe9}

\item Italiano
\label{sec:orge955fe2}
\begin{longtabu} to 0.9\textwidth {l|X|X|X|X|X|X}
\caption{意大利语人称代词表}
\\
\toprule
...
\section{物主代词}
\label{sec:org38cce36}

\begin{enumerate}
\item Français
\label{sec:org5c2595e}

\item Español
\label{sec:orgf99b0e2}

\item Italiano
\label{sec:org35f2065}
...
\section{指示代词}
\label{sec:orgbc62ab2}

\begin{enumerate}
\item Français
\label{sec:org126ecf1}

\item Español
\label{sec:orgedfa189}

\item Italiano
\label{sec:org265585a}
...
\section{疑问代词}
\label{sec:orgf7d6c6a}

\begin{enumerate}
\item Français
\label{sec:org33ed054}

\item Español
\label{sec:orgf3fb917}

\item Italiano
\label{sec:org1cc0820}
...
\section{关系代词}
\label{sec:orge2aef79}

\begin{enumerate}
\item Français
\label{sec:org50e159a}

\item Español
\label{sec:orge14947a}

\item Italiano
\label{sec:org2371cc7}
...
\chapter{形容词}
\label{sec:org71761ed}

\section{形容词概述}
\label{sec:org9022952}

\begin{enumerate}
\item Français
\label{sec:orga67a70c}

\item Español
\label{sec:orgebf7184}

\item Italiano
\label{sec:orge023673}
...
\section{物主形容词}
\label{sec:orgc700877}

\begin{enumerate}
\item Français
\label{sec:org5155233}

\item Español
\label{sec:org56d3d33}

\item Italiano
\label{sec:org38ebe7d}
...
\section{指示形容词}
\label{sec:org2fee047}

\begin{enumerate}
\item Français
\label{sec:orgac96a35}

\item Español
\label{sec:org728bc88}

\item Italiano
\label{sec:orgfd03162}
...
\section{疑问形容词}
\label{sec:orgf9e3b5d}

\begin{enumerate}
\item Français
\label{sec:orgf9c17e7}

\item Español
\label{sec:orgb7d09d8}

\item Italiano
\label{sec:org58ec182}
...
\chapter{数词}
\label{sec:org241f10c}

\section{概述}
\label{sec:orgc2a7324}

\begin{enumerate}
\item Français
\label{sec:org2c2c7b7}

\item Español
\label{sec:orgc2ee256}

\item Italiano
\label{sec:orge5d663a}
...
\chapter{动词}
\label{sec:org612e92a}

\section{时式}
\label{sec:org3cda146}

\begin{enumerate}
\item Français
\label{sec:org56c2533}

\item Español
\label{sec:org4921222}

\item Italiano
\label{sec:org25ad7ef}
...
togliere（摘） & tolsi & togliesti & tolse & togliemmo & toglieste & tolsero\\
...
\chapter{副词}
\label{sec:org57a5fb4}

\section{概述}
\label{sec:orgd73f234}

\begin{enumerate}
\item Français
\label{sec:org34c5dc7}

\item Español
\label{sec:org674ea5e}

\item Italiano
\label{sec:org27ad562}
\end{enumerate}

\chapter{介词}
\label{sec:org6291e2c}

\section{概述}
\label{sec:org18277f9}

\begin{enumerate}
\item Français
\label{sec:orgfa565f1}

\item Español
\label{sec:org6953747}

\item Italiano
\label{sec:orgcdb03be}
\end{enumerate}

\part{句法}
\label{sec:org32fa509}

\newpage
\part{附录}
\label{sec:orgee1e242}
