...
\part{序言}
\label{sec:orgc5520ff}

\chapter{简介}
\label{sec:orga386ef1}
...
\section{发展}
\label{sec:org4b6d6d5}

\begin{enumerate}
\item 演化
\label{sec:orgdd09d62}
...
\section{比较}
\label{sec:org4dfa4a1}

\begin{enumerate}
\item 共同点
\label{sec:orgf008714}
...
\part{语音}
\label{sec:orgca4be11}

\chapter{字母}
\label{sec:org66ae1f7}

\section{字母表}
\label{sec:orgc27ccd7}
\begin{enumerate}
\item Français
\label{sec:orgfa8afae}
...
\chapter{发音}
\label{sec:org4af2d7b}

\section{发音总表}
\label{sec:orgd732742}
...
\section{发音规则}
\label{sec:orgaac2ed1}

\begin{enumerate}
\item Français
\label{sec:org61a224b}
...
\part{语法}
\label{sec:org22f3636}

\chapter{名词}
\label{sec:org39fcd2a}

\section{概述}
\label{sec:org6e9c7c8}
...
\item Español
\label{sec:orgd5bc92f}

\item Italiano
\label{sec:orgab2f039}
\end{enumerate}

\chapter{冠词}
\label{sec:orgdc02c85}

\section{概述}
\label{sec:orgc438c38}

\begin{enumerate}
\item Français
\label{sec:org0423562}
...
\chapter{代词}
\label{sec:org735e394}

\section{人称代词}
\label{sec:org7774138}

\begin{enumerate}
\item Français
\label{sec:orgb3f7b8d}

\item Español
\label{sec:org0be1922}

\item Italiano
\label{sec:org2a8dc85}
\end{enumerate}

\section{主有代词}
\label{sec:orgb782b4e}

\begin{enumerate}
\item Français
\label{sec:orga674925}

\item Español
\label{sec:org418a8f7}

\item Italiano
\label{sec:org8a4aa5c}
\end{enumerate}

\section{指示代词}
\label{sec:org2892d7c}

\begin{enumerate}
\item Français
\label{sec:org68eaf53}

\item Español
\label{sec:orgd521267}

\item Italiano
\label{sec:org4bbaff9}
\end{enumerate}

\chapter{形容词}
\label{sec:org9861a0c}

\section{主有形容词}
\label{sec:orgdc3cc6a}

\begin{enumerate}
\item Français
\label{sec:orga556c2a}

\item Español
\label{sec:org3e81c2e}

\item Italiano
\label{sec:org59a4b3e}
\end{enumerate}

\section{指示形容词}
\label{sec:org2576548}

\begin{enumerate}
\item Français
\label{sec:org4a6b147}

\item Español
\label{sec:org8e86182}

\item Italiano
\label{sec:org1df75f0}
\end{enumerate}

\chapter{数词}
\label{sec:org7630aa5}

\section{概述}
\label{sec:org1cfd349}

\begin{enumerate}
\item Français
\label{sec:org7c7d6f2}

\item Español
\label{sec:orge80b993}

\item Italiano
\label{sec:org1770594}
\end{enumerate}

\chapter{动词}
\label{sec:org6769ea8}

\section{概述}
\label{sec:org66e2b4c}

\begin{enumerate}
\item Français
\label{sec:orge6542ad}

\item Español
\label{sec:orgbaf26e4}

\item Italiano
\label{sec:orgdd779ac}
\end{enumerate}

\chapter{副词}
\label{sec:org963dd4f}

\section{概述}
\label{sec:orga797cc1}

\begin{enumerate}
\item Français
\label{sec:orga1573d0}

\item Español
\label{sec:orgb0d7866}

\item Italiano
\label{sec:orga03021e}
\end{enumerate}

\chapter{介词}
\label{sec:org7a067f8}

\section{概述}
\label{sec:org94d23f8}

\begin{enumerate}
\item Français
\label{sec:orgc2b5183}

\item Español
\label{sec:org7c8b02a}

\item Italiano
\label{sec:org6f397fa}
\end{enumerate}

\part{句法}
\label{sec:org104ad94}

\newpage
\part{附录}
\label{sec:org803e8c9}
