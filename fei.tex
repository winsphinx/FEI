...
\part{序言}
\label{sec:org7238a2b}

\chapter{简介}
\label{sec:org61a7402}
...
\caption{\label{WorldMap}
分布图}
\end{figure}

\section{发展}
\label{sec:orga595d26}

\begin{enumerate}
\item 演化
\label{sec:org8ad3de1}
...
\caption{\label{FamilyMap}
演化图}
\end{figure}

\item 分支
\label{sec:org9142772}
...
\section{比较}
\label{sec:org35d30c2}

\begin{enumerate}
\item 共同点
\label{sec:org601002f}
...
\part{语音}
\label{sec:org7026b44}

\chapter{字母}
\label{sec:org0244d10}

\section{字母表}
\label{sec:org67eae46}
\begin{enumerate}
\item Français
\label{sec:org232ca51}

\begin{longtabu} to 0.9\textwidth {XXX|XXX}
\caption{\label{alphabet-f}
法语字母表}
\\
\toprule
字母 & 名称 & 读音 & 字母 & 名称 & 读音\\
...
\item Español
\label{sec:orgd47a9e6}

\begin{longtabu} to 0.9\textwidth {XXX|XXX}
\caption{\label{alphabet-e}
西班牙语字母表}
\\
\toprule
字母 & 名称 & 读音 & 字母 & 名称 & 读音\\
...
\section{音符表}
\label{sec:org91c8fed}

\begin{longtabu} to 0.9\textwidth {X|X|X|X}
\caption{\label{accent-all}
音符汇总表}
\\
\toprule
...
\chapter{发音}
\label{sec:orga0e252b}

\section{发音总表}
\label{sec:orgfa4a97c}

\begin{longtabu} to 0.9\textwidth {l|X|X|X}
\caption{\label{pronounce-v}
元音汇总表}
\\
\toprule
音标 & 法语 & 西班牙语 & 意大利语\\
...
\section{发音规则}
\label{sec:orgf2dd1f6}

\begin{enumerate}
\item Français
\label{sec:org44cf3be}

\begin{longtabu} to 0.9\textwidth {X|l|X}
\caption{\label{pronounce-f-v}
法语元音表}
\\
\toprule
字母组合 & 读音 & 例词\\
...
\item Español
\label{sec:orga01d1e7}

\begin{longtabu} to 0.9\textwidth {X|l|X}
\caption{\label{pronounce-e-v}
西班牙语元音表}
\\
\toprule
字母组合 & 读音 & 例词\\
...
\item Italiano
\label{sec:org40875ba}

\begin{longtabu} to 0.9\textwidth {X|l|X}
\caption{\label{pronounce-i-v}
意大利语元音表}
\\
\toprule
字母组合 & 读音 & 例词\\
...
\part{语法}
\label{sec:org9a0739c}

\chapter{名词}
\label{sec:orgcec4ebc}

\section{概述}
\label{sec:org8de6a1e}

\begin{enumerate}
\item Français
\label{sec:orgf2e68db}

\item Español
\label{sec:orge59b537}

\item Italiano
\label{sec:org6355782}
\end{enumerate}

\chapter{冠词}
\label{sec:orgb40da45}

\section{概述}
\label{sec:orga6f7189}

\begin{enumerate}
\item Français
\label{sec:org6cf7aa8}

\item Español
\label{sec:org335f58e}

\item Italiano
\label{sec:orged13eff}
\end{enumerate}

\chapter{代词}
\label{sec:orgfd97d29}

\section{人称代词}
\label{sec:org479d1fb}

\begin{enumerate}
\item Français
\label{sec:orgf5d4b68}

\item Español
\label{sec:org9bec118}

\item Italiano
\label{sec:orgba5fe4f}
\end{enumerate}

\section{主有代词}
\label{sec:org5f4f105}

\begin{enumerate}
\item Français
\label{sec:orga510a0f}

\item Español
\label{sec:org2f01055}

\item Italiano
\label{sec:org89b8fe8}
\end{enumerate}

\section{指示代词}
\label{sec:org09070eb}

\begin{enumerate}
\item Français
\label{sec:orgd703390}

\item Español
\label{sec:orgd983bfe}

\item Italiano
\label{sec:org8e03133}
\end{enumerate}

\chapter{形容词}
\label{sec:orga925e6d}

\section{主有形容词}
\label{sec:org22e48a1}

\begin{enumerate}
\item Français
\label{sec:org435b29b}

\item Español
\label{sec:orgac69f0d}

\item Italiano
\label{sec:org5b523a8}
\end{enumerate}

\section{指示形容词}
\label{sec:org3a08e41}

\begin{enumerate}
\item Français
\label{sec:orgc35d851}

\item Español
\label{sec:orga0b18e8}

\item Italiano
\label{sec:org4fbf7a0}
\end{enumerate}

\chapter{数词}
\label{sec:org638b2f7}

\section{概述}
\label{sec:org42b059f}

\begin{enumerate}
\item Français
\label{sec:org0164fab}

\item Español
\label{sec:org1c94c48}

\item Italiano
\label{sec:orgca9c9c0}
\end{enumerate}

\chapter{动词}
\label{sec:org8fa377f}

\section{概述}
\label{sec:orgb7152a0}

\begin{enumerate}
\item Français
\label{sec:org882d389}

\item Español
\label{sec:orgd6f4779}

\item Italiano
\label{sec:org87711da}
\end{enumerate}

\chapter{副词}
\label{sec:org84f73bc}

\section{概述}
\label{sec:orgc2d75ab}

\begin{enumerate}
\item Français
\label{sec:orge94ac99}

\item Español
\label{sec:org2a463bf}

\item Italiano
\label{sec:orgf1a719d}
\end{enumerate}

\chapter{介词}
\label{sec:org2c83052}

\section{概述}
\label{sec:org965f92f}

\begin{enumerate}
\item Français
\label{sec:org5afa0f7}

\item Español
\label{sec:orgdf0adf0}

\item Italiano
\label{sec:org23cb10d}
\end{enumerate}

\part{句法}
\label{sec:org8491864}

\newpage
\part{附录}
\label{sec:org0ba8c41}
