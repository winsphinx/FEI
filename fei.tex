...
\part{序言}
\label{sec:org9bcef73}

\chapter{简介}
\label{sec:org2f9f4cd}
...
\section{发展}
\label{sec:org38b51d9}

\begin{enumerate}
\item 演化
\label{sec:org3cac667}
...
\section{比较}
\label{sec:org384e575}

\begin{enumerate}
\item 共同点
\label{sec:org858cc2b}
...
\part{语音}
\label{sec:org3d60b2a}

\chapter{字母}
\label{sec:org0700020}

\section{字母表}
\label{sec:org091056e}

\begin{enumerate}
\item Français
\label{sec:org420db0c}
...
\chapter{发音}
\label{sec:org52ff424}

\section{发音总表}
\label{sec:orgb9716b7}
...
\section{发音规则}
\label{sec:org167f260}

\begin{enumerate}
\item Français
\label{sec:org493c5e9}
...
\part{语法}
\label{sec:org642a82f}

\chapter{名词}
\label{sec:org841c3ef}

\section{名词}
\label{sec:org934a13f}

名词有性（阳性、阴性）、数（单数、复数）的变化，基本上不再有格的变化。

\begin{enumerate}
\item Français
\label{sec:org249b59f}

\item Español
\label{sec:org307c8d6}

\item Italiano
\label{sec:orga9b1260}
...
\chapter{冠词}
\label{sec:orgf357cf0}

\section{冠词}
\label{sec:org7476804}

冠词有性（阳性、阴性）、数（单数、复数）的变化，要和其限定的名词做性数配合。

\begin{enumerate}
\item Français
\label{sec:orgd639a8c}
...
\chapter{代词}
\label{sec:org401d20a}

\section{代词}
\label{sec:org4f20709}

代词有性（阳性、阴性）、数（单数、复数）的变化。

\begin{enumerate}
\item Français
\label{sec:org8a65e2b}

\item Español
\label{sec:org1632bfa}

\item Italiano
\label{sec:orgebcefb1}
...
\begin{enumerate}
\item Français
\label{sec:org383e8fc}

\item Español
\label{sec:orga0a54b7}

\item Italiano
\label{sec:orgd48a46c}
...
\chapter{动词}
\label{sec:org1a81c93}

\section{动词}
\label{sec:org1045610}

动词有时（现在时、将来时、过去时）、式（直陈式、命令式、虚拟式、条件式）、态（主动态、被动态）、分词（现在分词、过去分词）等各种变化。

\begin{enumerate}
\item Français
\label{sec:org666e2a3}

\item Español
\label{sec:orgd06d5e0}

\item Italiano
\label{sec:org220c614}
