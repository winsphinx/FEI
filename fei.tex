...
\part{序言}
\label{sec:orge88a258}

\chapter{简介}
\label{sec:org610b91f}
...
\section{发展}
\label{sec:org1f715c1}

\begin{enumerate}
\item 演化
\label{sec:org2816b3c}
...
\section{比较}
\label{sec:orgcdfe482}

\begin{enumerate}
\item 共同点
\label{sec:org9ef6518}
...
\part{语音}
\label{sec:org12182fa}

\chapter{字母}
\label{sec:orga6e239a}

\section{字母表}
\label{sec:orga91217d}
\begin{enumerate}
\item Français
\label{sec:org4d0554c}
...
\chapter{发音}
\label{sec:org2180da6}

\section{发音总表}
\label{sec:org5f246cf}
...
\section{发音规则}
\label{sec:org62091d2}

\begin{enumerate}
\item Français
\label{sec:org9a09222}
...
\part{语法}
\label{sec:org4d55b5a}

\chapter{名词}
\label{sec:orgd42020f}

\section{概述}
\label{sec:orgeb00a42}

\begin{enumerate}
\item Français
\label{sec:orgffed73b}

\item Español
\label{sec:org1adcf41}

\item Italiano
\label{sec:org6996df2}
\end{enumerate}

\chapter{冠词}
\label{sec:orgadec3ad}

\section{概述}
\label{sec:org65244c5}

\begin{enumerate}
\item Français
\label{sec:orgd13a1b3}
...
\chapter{代词}
\label{sec:orgaf52b5f}

\section{人称代词}
\label{sec:orge0dba0f}

\begin{enumerate}
\item Français
\label{sec:org5784890}

\item Español
\label{sec:orgbf7c3ff}

\item Italiano
\label{sec:orge176421}
\end{enumerate}

\section{主有代词}
\label{sec:org19cfe6a}

\begin{enumerate}
\item Français
\label{sec:org7c0b57a}

\item Español
\label{sec:org9c9b8f8}

\item Italiano
\label{sec:org61990c7}
\end{enumerate}

\section{指示代词}
\label{sec:org75b20a9}

\begin{enumerate}
\item Français
\label{sec:orgaf0114a}

\item Español
\label{sec:org2b8aa06}

\item Italiano
\label{sec:orgac96461}
\end{enumerate}

\chapter{形容词}
\label{sec:org77b0acc}

\section{主有形容词}
\label{sec:org2f2b2ca}

\begin{enumerate}
\item Français
\label{sec:org05690a7}

\item Español
\label{sec:orgdf9b360}

\item Italiano
\label{sec:orgbeb7b04}
\end{enumerate}

\section{指示形容词}
\label{sec:org5b5e91d}

\begin{enumerate}
\item Français
\label{sec:org82fa3fb}

\item Español
\label{sec:org095a0ec}

\item Italiano
\label{sec:org7110963}
\end{enumerate}

\chapter{数词}
\label{sec:org8a4f700}

\section{概述}
\label{sec:orgebeda8f}

\begin{enumerate}
\item Français
\label{sec:org08f8546}

\item Español
\label{sec:org628575f}

\item Italiano
\label{sec:org5894d6d}
\end{enumerate}

\chapter{动词}
\label{sec:orgd604153}

\section{概述}
\label{sec:orgd653eff}

\begin{enumerate}
\item Français
\label{sec:org36a26ef}

\item Español
\label{sec:org72d6007}

\item Italiano
\label{sec:orgbf4e889}
\end{enumerate}

\chapter{副词}
\label{sec:orgc6c7364}

\section{概述}
\label{sec:orgb32127f}

\begin{enumerate}
\item Français
\label{sec:orge5383a6}

\item Español
\label{sec:orgdfa89a8}

\item Italiano
\label{sec:orge1c0783}
\end{enumerate}

\chapter{介词}
\label{sec:org4015a83}

\section{概述}
\label{sec:orgaacfddc}

\begin{enumerate}
\item Français
\label{sec:org88b101b}

\item Español
\label{sec:orgf4c1dd1}

\item Italiano
\label{sec:orgf09f19b}
\end{enumerate}

\part{句法}
\label{sec:orgab76cb5}

\newpage
\part{附录}
\label{sec:org0e29d84}
