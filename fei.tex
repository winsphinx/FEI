...
\part{序言}
\label{sec:org405ccb2}

\chapter{简介}
\label{sec:org7d73b75}
...
\section{发展}
\label{sec:orga1e462d}

\begin{enumerate}
\item 演化
\label{sec:org3b91e87}
...
\section{比较}
\label{sec:orge79ee18}

\begin{enumerate}
\item 共同点
\label{sec:org11f97aa}
...
\part{语音}
\label{sec:org4f0c9d9}

\chapter{字母}
\label{sec:orgec71712}

\section{字母表}
\label{sec:orgc03ca80}
\begin{enumerate}
\item Français
\label{sec:org2abe56b}
...
\chapter{发音}
\label{sec:orgf11983f}

\section{发音总表}
\label{sec:org29477ea}
...
\section{发音规则}
\label{sec:org53ead71}

\begin{enumerate}
\item Français
\label{sec:orge4e2cb5}
...
\part{语法}
\label{sec:orgb2439f1}

\chapter{名词}
\label{sec:orge8838b5}

\section{概述}
\label{sec:org18253a5}

\begin{enumerate}
\item Français
\label{sec:orgab7f2e1}

\item Español
\label{sec:orge1c8c0e}

\item Italiano
\label{sec:org6de68dc}
\end{enumerate}

\chapter{冠词}
\label{sec:org80f8fe2}

\section{概述}
\label{sec:orgc287ede}

\begin{enumerate}
\item Français
\label{sec:org0249a5b}
...
\chapter{代词}
\label{sec:orgd59e653}

\section{人称代词}
\label{sec:orgb21cb85}

\begin{enumerate}
\item Français
\label{sec:orge869b95}

\item Español
\label{sec:org944c0a8}

\item Italiano
\label{sec:org369c4a9}
...
\section{主有代词}
\label{sec:orga4f6bed}

\begin{enumerate}
\item Français
\label{sec:orgf685d11}

\item Español
\label{sec:org1133fa9}

\item Italiano
\label{sec:orgae04f56}
\end{enumerate}

\section{指示代词}
\label{sec:org16c2d3f}

\begin{enumerate}
\item Français
\label{sec:orga80435e}

\item Español
\label{sec:orgf66502f}

\item Italiano
\label{sec:org7f8e5b8}
\end{enumerate}

\chapter{形容词}
\label{sec:org87ca080}

\section{主有形容词}
\label{sec:org58573cd}

\begin{enumerate}
\item Français
\label{sec:orgf02e997}

\item Español
\label{sec:orgaaba7da}

\item Italiano
\label{sec:org77a2d18}
\end{enumerate}

\section{指示形容词}
\label{sec:orga4eee51}

\begin{enumerate}
\item Français
\label{sec:org0027d68}

\item Español
\label{sec:org288e550}

\item Italiano
\label{sec:org7205446}
\end{enumerate}

\chapter{数词}
\label{sec:org0be3071}

\section{概述}
\label{sec:org22ade56}

\begin{enumerate}
\item Français
\label{sec:orgade47ff}

\item Español
\label{sec:orgf690792}

\item Italiano
\label{sec:orge27dd19}
\end{enumerate}

\chapter{动词}
\label{sec:orgec4762b}

\section{概述}
\label{sec:org660e949}

\begin{enumerate}
\item Français
\label{sec:orga6279e8}

\item Español
\label{sec:org08e6a52}

\item Italiano
\label{sec:orgda0a446}
\begin{longtabu} to 0.9\textwidth {l|X|X|X|X}
...
\chapter{副词}
\label{sec:orge74efa7}

\section{概述}
\label{sec:orgcfbfe25}

\begin{enumerate}
\item Français
\label{sec:orgf77d535}

\item Español
\label{sec:orgc710d62}

\item Italiano
\label{sec:org2307068}
\end{enumerate}

\chapter{介词}
\label{sec:org8d63c74}

\section{概述}
\label{sec:org897b068}

\begin{enumerate}
\item Français
\label{sec:org2e4d117}

\item Español
\label{sec:orgdcf42cf}

\item Italiano
\label{sec:org8db03a4}
\end{enumerate}

\part{句法}
\label{sec:orgc584d6a}

\newpage
\part{附录}
\label{sec:org65267ca}
