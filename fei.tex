...
\part{序言}
\label{sec:orga30542c}

\chapter{简介}
\label{sec:org39b070a}
...
\section{发展}
\label{sec:orga64a6ae}

\begin{enumerate}
\item 演化
\label{sec:org9b5d19a}
...
\section{比较}
\label{sec:org58ae852}

\begin{enumerate}
\item 共同点
\label{sec:org8504b8b}
...
\part{语音}
\label{sec:orgad61b69}

\chapter{字母}
\label{sec:orgad28594}

\section{字母表}
\label{sec:org5fb1330}
\begin{enumerate}
\item Français
\label{sec:orgb12995d}
...
\chapter{发音}
\label{sec:org788819f}

\section{发音总表}
\label{sec:org20c590b}
...
\section{发音规则}
\label{sec:org56296c6}

\begin{enumerate}
\item Français
\label{sec:org33c44f2}
...
\part{语法}
\label{sec:orgcb03a75}

\chapter{名词}
\label{sec:orgeb295d4}

\section{概述}
\label{sec:org3f6c189}

\begin{enumerate}
\item Français
\label{sec:org33d3a41}

\item Español
\label{sec:org73fd397}

\item Italiano
\label{sec:orge123523}
...
\chapter{冠词}
\label{sec:org32d1636}

\section{概述}
\label{sec:org7f09dbc}

\begin{enumerate}
\item Français
\label{sec:org29049e4}
...
\chapter{代词}
\label{sec:org9b83611}

\section{人称代词}
\label{sec:org60e1240}

\begin{enumerate}
\item Français
\label{sec:org4106116}

\item Español
\label{sec:org22d4112}

\item Italiano
\label{sec:org481853a}
\begin{longtabu} to 0.9\textwidth {l|X|X|X|X|X|X}
\caption{意大利语人称代词表}
\\
\toprule
...
\section{物主代词}
\label{sec:org0754528}

\begin{enumerate}
\item Français
\label{sec:org83a6a48}

\item Español
\label{sec:org99778ac}

\item Italiano
\label{sec:orgf73e1a3}
...
\section{指示代词}
\label{sec:orgd87f64d}

\begin{enumerate}
\item Français
\label{sec:org7b7c98a}

\item Español
\label{sec:orgef17a78}

\item Italiano
\label{sec:orgc2f0bfa}
...
\section{疑问代词}
\label{sec:org2d047b6}

\begin{enumerate}
\item Français
\label{sec:orgde03c82}

\item Español
\label{sec:orgf5e3096}

\item Italiano
\label{sec:orgb6f9587}
...
\section{关系代词}
\label{sec:orgc76920b}

\begin{enumerate}
\item Français
\label{sec:orgb030402}

\item Español
\label{sec:orgf7e4896}

\item Italiano
\label{sec:orgb11818f}
...
\chapter{形容词}
\label{sec:org50012fc}

\section{形容词}
\label{sec:org99de945}

\begin{enumerate}
\item Français
\label{sec:orgda8a9a6}

\item Español
\label{sec:orgb2ce4ee}

\item Italiano
\label{sec:org2806540}
...
\section{物主形容词}
\label{sec:org37e44d1}

\begin{enumerate}
\item Français
\label{sec:org13c3bed}

\item Español
\label{sec:org71dddd6}

\item Italiano
\label{sec:org6f6fd6c}
...
\section{指示形容词}
\label{sec:org5bcd33d}

\begin{enumerate}
\item Français
\label{sec:org6c1410f}

\item Español
\label{sec:org621d674}

\item Italiano
\label{sec:org5fe412f}
...
\section{疑问形容词}
\label{sec:org8477081}

\begin{enumerate}
\item Français
\label{sec:org863fba3}

\item Español
\label{sec:orga5b8be6}

\item Italiano
\label{sec:org8333f6f}
...
\chapter{数词}
\label{sec:org860b733}

\section{概述}
\label{sec:org18ca8e8}

\begin{enumerate}
\item Français
\label{sec:org7b03426}

\item Español
\label{sec:orgfd810db}

\item Italiano
\label{sec:orgc4d4200}

\begin{longtabu} to 0.9\textwidth {l|X|l|X|l|X|l|X|l|X}
\caption{意大利语基数词表}
\\
\toprule
数字 & 拼写 & 数字 & 拼写 & 数字 & 拼写 & 数字 & 拼写 & 数字 & 拼写\\
\midrule
\endfirsthead
...
\endfoot
\endlastfoot
1 & uno & 11 & undici & 21 & ventuno &  &  & 101 & centouno/centuno\\
2 & due & 12 & dodici & 22 & ventidue &  &  & 111 & centoundici\\
3 & tre & 13 & tredici & 23 & ventitré & 30 & trenta & 120 & centoventi\\
4 & quattro & 14 & quattordici & 24 & ventiquattro & 40 & quaranta & 200 & duecento\\
5 & cinque & 15 & quindici & 25 & venticinque & 50 & cinquanta & 1.000 & mille\\
6 & six & 16 & sedici & 26 & ventisci & 60 & sessanta & 1.001 & milleuno/mille e uno\\
7 & sette & 17 & diciassette & 27 & ventisette & 70 & settanta & 1.150 & millecentocinquanta\\
8 & otto & 18 & diciotto & 28 & ventotto & 80 & ottanta & 2.000 & duemila\\
9 & nove & 19 & diciannove & 29 & ventinove & 90 & novanta & 100.000 & centomila\\
10 & dieci & 20 & venti &  &  & 100 & cento & 200.000 & duecentomila\\
\bottomrule
\end{longtabu}
...
\endfoot
\endlastfoot
1° & primo & 11° & undicesimo/undecimo & 21° & ventunesimo/ventesimoprimo &  &  & 101° & centesimoprimo\\
2° & scondo & 12° & dodicesimo/duodecimo & 22° & ventiduesimo/ventesimosecondo &  &  & 111° & centesimoundicesimo/centesimoundecimo\\
3° & terzo & 13° & tredicesimo/decimoterzo & 23° & ventitreesimo/ventesimoterzo & 30° & trentesimo & 120° & centesimoventesimo\\
4° & quarto & 14° & quattordicesimo/decimoquarto & 24° & ventiquattresimo/ventesimoquarto & 40° & quarantesimo & 200° & duecentesimo\\
5° & quinto & 15° & quindicesimo/decimoquinto & 25° & venticinquesimo/ventesimoquinto & 50° & cinquantesimo & 1.000° & millesimo\\
6° & sesto & 16° & sedicesimo/decimosesto & 26° & ventiscesimo/ventesimosesto & 60° & sessantesimo & 1.001° & millesimoprimo\\
7° & settimo & 17° & diciassettesimo/decimosettimo & 27° & ventisettesimo/ventesimosettimo & 70° & settantesimo & 1.150° & millesimocentesimocinquantesimo\\
8° & ottavo & 18° & diciottesimo/decimoottavo & 28° & ventottesimo/ventesimoottavo & 80° & ottantesimo & 2.000° & duemillesimo\\
9° & nono & 19° & diciannovesimo/decimonono & 29° & ventinovesimo/ventesimonono & 90° & novantesimo & 100.000° & centomillesimo\\
10° & decimo & 20° & ventesimo &  &  & 100° & centesimo & 200.000° & duecentomillesimo\\
\bottomrule
\end{longtabu}
...
\chapter{动词}
\label{sec:org16977e0}

\section{概述}
\label{sec:orgeb510d5}

\begin{enumerate}
\item Français
\label{sec:org680d870}

\item Español
\label{sec:orgc130c87}

\item Italiano
\label{sec:org3809fbb}
...
\chapter{副词}
\label{sec:org1868a01}

\section{概述}
\label{sec:org88c41e4}

\begin{enumerate}
\item Français
\label{sec:orge564e8b}

\item Español
\label{sec:orgd55278c}

\item Italiano
\label{sec:org16c3e85}
\end{enumerate}

\chapter{介词}
\label{sec:org0ef5883}

\section{概述}
\label{sec:org76b85c0}

\begin{enumerate}
\item Français
\label{sec:orgc79eae3}

\item Español
\label{sec:org96784e3}

\item Italiano
\label{sec:orgbf49faf}
\end{enumerate}

\part{句法}
\label{sec:org27019bd}

\newpage
\part{附录}
\label{sec:orgb1e0610}
