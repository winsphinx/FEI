...
\part{序言}
\label{sec:orge050773}

\chapter{简介}
\label{sec:orga01a626}
...
\section{发展}
\label{sec:orgc4119fd}

\begin{enumerate}
\item 演化
\label{sec:org2cda26d}
...
\section{比较}
\label{sec:org73142bb}

\begin{enumerate}
\item 共同点
\label{sec:org23e38c0}
...
\part{语音}
\label{sec:orgd9605a1}

\chapter{字母}
\label{sec:orgee8aaa2}

\section{字母表}
\label{sec:orgfb67efd}

\begin{enumerate}
\item Français
\label{sec:org0b9c260}
...
\chapter{发音}
\label{sec:org56e65bb}

\section{发音总表}
\label{sec:org82f318e}
...
\section{发音规则}
\label{sec:org30d4dd4}

\begin{enumerate}
\item Français
\label{sec:org6f902de}
...
\part{语法}
\label{sec:orgad36738}

\chapter{名词}
\label{sec:org4804da1}

\section{名词}
\label{sec:org0c479ef}

名词有性（阳性、阴性）、数（单数、复数）的变化，基本上不再有格的变化。

\begin{enumerate}
\item Français
\label{sec:org74aca5b}

\item Español
\label{sec:org6e44c67}

\item Italiano
\label{sec:orgffb7c8e}
...
\chapter{冠词}
\label{sec:orgf11f0d3}

\section{冠词}
\label{sec:org5b2a30f}

冠词有性（阳性、阴性）、数（单数、复数）的变化，要和其限定的名词做性数配合。

\begin{enumerate}
\item Français
\label{sec:org012a982}
...
\chapter{代词}
\label{sec:org69dcb42}

\section{代词}
\label{sec:orgddfaad7}

代词有性（阳性、阴性）、数（单数、复数）的变化。

\begin{enumerate}
\item Français
\label{sec:orgde0582c}

\item Español
\label{sec:org0011866}

\item Italiano
\label{sec:org520fdaa}
...
\chapter{形容词}
\label{sec:org565709f}

\section{形容词}
\label{sec:org3f0b0c0}

形容词有性（阳性、阴性）、数（单数、复数）的变化，要和其限定的名词做性数配合。

\begin{enumerate}
\item Français
\label{sec:org5196007}

\item Español
\label{sec:org7ff66a4}

\item Italiano
\label{sec:org7118d1f}
...
\chapter{数词}
\label{sec:orgc1879fb}

\section{数词}
\label{sec:orgded2f87}

数词分基数词和序数词。基数词“1”需要和计数的名词的性一致。序数词要与被计数名词保持性数一致。

\begin{enumerate}
\item Français
\label{sec:org61de2b7}

\item Español
\label{sec:org89cbabf}

\item Italiano
\label{sec:org49a86ef}
...
\chapter{动词}
\label{sec:orgaa90a8f}

\section{动词}
\label{sec:org509b74e}

动词有时（现在时、将来时、过去时）、式（直陈式、命令式、虚拟式、条件式）、态（主动态、被动态）、分词（现在分词、过去分词）等各种变化。

\begin{enumerate}
\item Français
\label{sec:org1693aa9}

\item Español
\label{sec:org5683ed8}

\item Italiano
\label{sec:org8d565a7}
...
\chapter{副词}
\label{sec:org6c08dd2}

\section{副词}
\label{sec:org486defd}

\begin{enumerate}
\item Français
\label{sec:org3ca251e}

\item Español
\label{sec:org95e3562}

\item Italiano
\label{sec:org9c93543}
\end{enumerate}

\chapter{介词}
\label{sec:org5ddbb3a}

\section{介词}
\label{sec:org17795a6}

\begin{enumerate}
\item Français
\label{sec:orge19645f}

\item Español
\label{sec:orgbda211e}

\item Italiano
\label{sec:org726f954}
\end{enumerate}

\part{句法}
\label{sec:org4715646}

\newpage
\part{附录}
\label{sec:orgf780e1d}
