...
\part{序言}
\label{sec:orgcfadf1e}

\chapter{简介}
\label{sec:org9fb3511}
...
\caption{\label{fig:orgbd2f4f2}
分布图}
\end{figure}

\section{发展}
\label{sec:orgd4a7a46}
...
\section{比较}
\label{sec:org033fbee}

\begin{enumerate}
\item 共同点
\label{sec:orgd0775b9}
...
\item Italiano
\label{sec:org69a0c7d}

\begin{longtabu} to 0.9\textwidth {XXX|XXX}
\caption{\label{tab:orgacbea30}
意大利语字母表}
\\
\toprule
字母 & 名称 & 读音 & 字母 & 名称 & 读音\\
...
\section{发音规则}
\label{sec:orgca4894f}

\begin{enumerate}
\item Français
\label{sec:org2c0282b}

\begin{longtabu} to 0.9\textwidth {X|l|X}
\caption{\label{tab:org7e0ec2c}
法语元音表}
\\
\toprule
字母组合 & 读音 & 例词\\
...
\item Español
\label{sec:org08aff4a}

\begin{longtabu} to 0.9\textwidth {X|l|X}
\caption{\label{tab:org0b95a4e}
西班牙语元音表}
\\
\toprule
字母组合 & 读音 & 例词\\
...
\item Italiano
\label{sec:org1410c29}

\begin{longtabu} to 0.9\textwidth {X|l|X}
\caption{\label{tab:org58d3804}
意大利语元音表}
\\
\toprule
字母组合 & 读音 & 例词\\
