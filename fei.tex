...
\part{序言}
\label{sec:orgd322ef3}

\chapter{简介}
\label{sec:orga402d60}
...
\section{发展}
\label{sec:orgcf44b3f}

\begin{enumerate}
\item 演化
\label{sec:orga57a28f}
...
\section{比较}
\label{sec:org7ba4ba3}

\begin{enumerate}
\item 共同点
\label{sec:orgd9f3671}
...
\part{语音}
\label{sec:org84209f1}

\chapter{字母}
\label{sec:org65e0fbe}

\section{字母表}
\label{sec:org12fbe57}

\begin{enumerate}
\item Français
\label{sec:orge1f7f8e}
...
\chapter{发音}
\label{sec:org7ca447f}

\section{发音总表}
\label{sec:orge21934b}
...
\section{发音规则}
\label{sec:org7fa2bd5}

\begin{enumerate}
\item Français
\label{sec:org5cbf3e3}
...
\part{语法}
\label{sec:orgcbae5d8}

\chapter{名词}
\label{sec:org4da42d0}

\section{名词}
\label{sec:orgfcf0fb3}

名词有性（阳性、阴性）、数（单数、复数）的变化，基本上不再有格的变化。

\begin{enumerate}
\item Français
\label{sec:org696332e}

\item Español
\label{sec:orgc512fa1}

\item Italiano
\label{sec:org0c557b5}
...
\chapter{冠词}
\label{sec:orgfa13dc2}

\section{冠词}
\label{sec:org8731414}

冠词有性（阳性、阴性）、数（单数、复数）的变化，要和其限定的名词做性数配合。

\begin{enumerate}
\item Français
\label{sec:orgb744620}
...
\chapter{代词}
\label{sec:org665b2fd}

\section{代词}
\label{sec:org57de8f2}

代词有性（阳性、阴性）、数（单数、复数）的变化。

\begin{enumerate}
\item Français
\label{sec:org98a1929}

\item Español
\label{sec:org52b4777}

\item Italiano
\label{sec:org1b5f9b2}
...
\begin{enumerate}
\item Français
\label{sec:org8042d1b}

\item Español
\label{sec:orgfe194b0}

\item Italiano
\label{sec:orga7c446d}
...
\chapter{动词}
\label{sec:org4c45b4b}

\section{动词}
\label{sec:orgb4473b6}

动词有时（现在时、将来时、过去时）、式（直陈式、命令式、虚拟式、条件式）、态（主动态、被动态）、分词（现在分词、过去分词）等各种变化。

\begin{enumerate}
\item Français
\label{sec:org6a8cb05}

\item Español
\label{sec:orgc2f293f}

\item Italiano
\label{sec:org7144f99}
