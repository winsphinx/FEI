...
\part{序言}
\label{sec:org634649a}

\chapter{简介}
\label{sec:org086c68c}
...
\caption{\label{WorldMap}分布图}
\end{figure}

\section{发展}
\label{sec:org456107a}

\begin{enumerate}
\item 演化
\label{sec:orgf535eb2}
...
\caption{\label{FamilyMap}演化图}
\end{figure}

\item 分支
\label{sec:org1a6d036}
...
\section{比较}
\label{sec:org09e4dba}

\begin{enumerate}
\item 共同点
\label{sec:orgdb3e938}
...
\part{语音}
\label{sec:org4c57bf7}

\chapter{字母}
\label{sec:orgfffbad0}

\section{字母表}
\label{sec:orga5bedb2}
\begin{enumerate}
\item Français
\label{sec:orgab9e368}

\begin{longtabu} to 0.9\textwidth {XXX|XXX}
\caption{\label{alphabet-f}法语字母表}
\\
\toprule
字母 & 名称 & 读音 & 字母 & 名称 & 读音\\
\midrule
...
\item Español
\label{sec:org168b582}

\begin{longtabu} to 0.9\textwidth {XXX|XXX}
\caption{\label{alphabet-e}西班牙语字母表}
\\
\toprule
字母 & 名称 & 读音 & 字母 & 名称 & 读音\\
\midrule
...
\item Italiano
\label{sec:orgef53034}

\begin{longtabu} to 0.9\textwidth {XXX|XXX}
\caption{\label{alphabet-e}意大利语字母表}
\\
\toprule
字母 & 名称 & 读音 & 字母 & 名称 & 读音\\
\midrule
...
\section{音符表}
\label{sec:orga0434d3}

\begin{longtabu} to 0.9\textwidth {X|X|X|X}
\caption{\label{accent-all}音符汇总表}
\\
\toprule
...
\chapter{发音}
\label{sec:org7d30444}

\section{发音总表}
\label{sec:org920f1e2}

\begin{longtabu} to 0.9\textwidth {l|X|X|X}
\caption{\label{pronounce-v}元音汇总表}
\\
\toprule
音标 & 法语 & 西班牙语 & 意大利语\\
\midrule
...
\section{发音规则}
\label{sec:orgfbe5647}

\begin{enumerate}
\item Français
\label{sec:orgc74c579}

\begin{longtabu} to 0.9\textwidth {X|l|X}
\caption{\label{pronounce-f-v}法语元音表}
\\
\toprule
字母组合 & 读音 & 例词\\
\midrule
...
\item Español
\label{sec:org3a9b82a}

\begin{longtabu} to 0.9\textwidth {X|l|X}
\caption{\label{pronounce-e-v}西班牙语元音表}
\\
\toprule
字母组合 & 读音 & 例词\\
\midrule
...
\begin{longtabu} to 0.9\textwidth {X|l|X}
\caption{\label{pronounce-e-c}西班牙语辅音表}
\\
\toprule
字母组合 & 读音 & 例词\\
\midrule
...
\item Italiano
\label{sec:orgdf0f21f}

\begin{longtabu} to 0.9\textwidth {X|l|X}
\caption{\label{pronounce-i-v}意大利语元音表}
\\
\toprule
字母组合 & 读音 & 例词\\
\midrule
...
\begin{longtabu} to 0.9\textwidth {X|l|X}
\caption{\label{pronounce-i-c}意大利语辅音表}
\\
\toprule
字母组合 & 读音 & 例词\\
\midrule
...
\part{语法}
\label{sec:org66c3f4e}

\chapter{名词}
\label{sec:org2baf6d9}

\section{概述}
\label{sec:org8acf715}

\begin{enumerate}
\item Français
\label{sec:org35785b0}

\item Español
\label{sec:org2240b8f}

\item Italiano
\label{sec:org6d8242f}
\end{enumerate}

\chapter{冠词}
\label{sec:org8fdb3ec}

\section{概述}
\label{sec:orgc91f48b}

\begin{enumerate}
\item Français
\label{sec:org49a26ac}
...
\chapter{代词}
\label{sec:org9af3956}

\section{人称代词}
\label{sec:orgf7a0c34}

\begin{enumerate}
\item Français
\label{sec:org9915b4b}

\item Español
\label{sec:org8fe3575}

\item Italiano
\label{sec:orgb5e9471}
\begin{longtabu} to 0.9\textwidth {l|X|X|X|X}
\caption{\label{person-i}意大利语人称代词表}
\\
\toprule
 & 人称 & 主格 & 直接宾语 & 间接宾语\\
\midrule
...
\item Español
\label{sec:orgd49f509}

\item Italiano
\label{sec:org31228bb}
\end{enumerate}

\section{指示代词}
\label{sec:orge82b2fb}

\begin{enumerate}
\item Français
\label{sec:orga1c31d3}

\item Español
\label{sec:org7cb6738}

\item Italiano
\label{sec:org2fa7d6b}
\end{enumerate}

\chapter{形容词}
\label{sec:org546dfbc}

\section{主有形容词}
\label{sec:orgdd95301}

\begin{enumerate}
\item Français
\label{sec:orgbaa970b}

\item Español
\label{sec:org4a83c7f}

\item Italiano
\label{sec:org788b67e}
\end{enumerate}

\section{指示形容词}
\label{sec:orgc9819cd}

\begin{enumerate}
\item Français
\label{sec:orgb5546b2}

\item Español
\label{sec:org6d5f804}

\item Italiano
\label{sec:orgf5a3394}
\end{enumerate}

\chapter{数词}
\label{sec:orgbf91a9a}

\section{概述}
\label{sec:orgb88d4c2}

\begin{enumerate}
\item Français
\label{sec:org0a9221c}

\item Español
\label{sec:org5623c9a}

\item Italiano
\label{sec:orgb9132fe}
\end{enumerate}

\chapter{动词}
\label{sec:orgd44668a}

\section{概述}
\label{sec:org25360ea}

\begin{enumerate}
\item Français
\label{sec:org15ae24f}

\item Español
\label{sec:org0c0ff50}

\item Italiano
\label{sec:orgb13ee75}
\begin{longtabu} to 0.9\textwidth {l|X|X|X}
\caption{\label{verb-present-i}意大利语直陈式动词变位表}
\\
\toprule
人称 & -are & -ere & -ire\\
\midrule
...
\section{概述}
\label{sec:org76af158}

\begin{enumerate}
\item Français
\label{sec:orgd8b7cfa}

\item Español
\label{sec:org4f72e68}

\item Italiano
\label{sec:org4e1f915}
\end{enumerate}

\chapter{介词}
\label{sec:orgeb54c09}

\section{概述}
\label{sec:org85dbca5}

\begin{enumerate}
\item Français
\label{sec:org45efb4f}

\item Español
\label{sec:orgcb5d34b}

\item Italiano
\label{sec:orgaa5fa9c}
\end{enumerate}

\part{句法}
\label{sec:org74ff78c}

\newpage
\part{附录}
\label{sec:orgbb78165}
