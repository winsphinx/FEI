...
\part{序言}
\label{sec:org479ebe1}

\chapter{简介}
\label{sec:org175a144}
...
\section{发展}
\label{sec:orgd8d4849}

\begin{enumerate}
\item 演化
\label{sec:orgf4923a2}
...
\section{比较}
\label{sec:orgdaefec5}

\begin{enumerate}
\item 共同点
\label{sec:org5afd032}
...
\part{语音}
\label{sec:org7e20232}

\chapter{字母}
\label{sec:org375f872}

\section{字母表}
\label{sec:org12d9f4c}
\begin{enumerate}
\item Français
\label{sec:orgcb8016f}
...
\chapter{发音}
\label{sec:org41673da}

\section{发音总表}
\label{sec:org7ffdc33}
...
\section{发音规则}
\label{sec:orgc93ce36}

\begin{enumerate}
\item Français
\label{sec:org35598e1}
...
\part{语法}
\label{sec:org9f64d4f}

\chapter{名词}
\label{sec:org538bb6f}

\section{概述}
\label{sec:org52d839d}

\begin{enumerate}
\item Français
\label{sec:orgcfeb989}

\item Español
\label{sec:org1e3b581}

\item Italiano
\label{sec:orgb2e1be2}
...
\chapter{冠词}
\label{sec:org310b040}

\section{概述}
\label{sec:orge85571c}

\begin{enumerate}
\item Français
\label{sec:org9d14c19}
...
\chapter{代词}
\label{sec:org3323c94}

\section{人称代词}
\label{sec:org8a7b6d1}

\begin{enumerate}
\item Français
\label{sec:org47a6da5}

\item Español
\label{sec:org2db1aab}

\item Italiano
\label{sec:orgebd1c30}
\begin{longtabu} to 0.9\textwidth {l|X|X|X|X|X|X}
\caption{意大利语人称代词表}
\\
\toprule
...
\section{物主代词}
\label{sec:org4b09af9}

\begin{enumerate}
\item Français
\label{sec:org6396ede}

\item Español
\label{sec:org2fa4a76}

\item Italiano
\label{sec:org0b27b51}
...
\section{指示代词}
\label{sec:org863dbc8}

\begin{enumerate}
\item Français
\label{sec:org26f73b2}

\item Español
\label{sec:orgfddffbe}

\item Italiano
\label{sec:org0c663e7}
...
\section{疑问代词}
\label{sec:org46e282b}

\begin{enumerate}
\item Français
\label{sec:org16de527}

\item Español
\label{sec:orge5a7539}

\item Italiano
\label{sec:orgf269c78}
...
\section{关系代词}
\label{sec:orge9a219c}

\begin{enumerate}
\item Français
\label{sec:org29a6246}

\item Español
\label{sec:orgd603cb4}

\item Italiano
\label{sec:orgb35a5f6}
...
\chapter{形容词}
\label{sec:orgdb8abb1}

\section{形容词概述}
\label{sec:orgbc77a9f}

\begin{enumerate}
\item Français
\label{sec:orgc39c32c}

\item Español
\label{sec:orgbb02276}

\item Italiano
\label{sec:orgec0b60f}
...
\section{物主形容词}
\label{sec:org50002df}

\begin{enumerate}
\item Français
\label{sec:org1c2451e}

\item Español
\label{sec:org66af43f}

\item Italiano
\label{sec:org71a58c2}
...
\section{指示形容词}
\label{sec:orgd418504}

\begin{enumerate}
\item Français
\label{sec:org8112934}

\item Español
\label{sec:org355b2ca}

\item Italiano
\label{sec:org4ad1bd8}
...
\section{疑问形容词}
\label{sec:orgf732580}

\begin{enumerate}
\item Français
\label{sec:org59d3e21}

\item Español
\label{sec:org290a953}

\item Italiano
\label{sec:org8dcb2da}
...
\chapter{数词}
\label{sec:org5e8e7ef}

\section{概述}
\label{sec:org1b649ff}

\begin{enumerate}
\item Français
\label{sec:org10099ce}

\item Español
\label{sec:orgf949c8a}

\item Italiano
\label{sec:orgd633565}
...
\chapter{动词}
\label{sec:org5a1ca0a}

\section{时式}
\label{sec:org8740dd1}

\begin{enumerate}
\item Français
\label{sec:orga830440}

\item Español
\label{sec:orgb2ae239}

\item Italiano
\label{sec:org7ac1272}

意大利语动词的时式总览如下：
\begin{center}
\includegraphics[width=.9\linewidth]{images/italian-verb.png}
\end{center}
...
\section{形式}
\label{sec:org8c176f3}

\begin{enumerate}
\item Français
\label{sec:org721b46f}

\item Español
\label{sec:org500ceee}

\item Italiano
\label{sec:org1436d0b}
...
\chapter{副词}
\label{sec:orgcc164fe}

\section{概述}
\label{sec:org1d7ee46}

\begin{enumerate}
\item Français
\label{sec:orga19484e}

\item Español
\label{sec:org5287f49}

\item Italiano
\label{sec:orgf500ef5}
\end{enumerate}

\chapter{介词}
\label{sec:org46ecfe1}

\section{概述}
\label{sec:org1a8aac4}

\begin{enumerate}
\item Français
\label{sec:orge90d9c1}

\item Español
\label{sec:orge79504e}

\item Italiano
\label{sec:orge204585}
\end{enumerate}

\part{句法}
\label{sec:org709a649}

\newpage
\part{附录}
\label{sec:org2232a24}
