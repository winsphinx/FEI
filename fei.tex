...
\part{序言}
\label{sec:org1934bd3}

\chapter{简介}
\label{sec:orgf0fce26}
...
\caption{\label{fig:org871a27f}
分布图}
\end{figure}

\section{发展}
\label{sec:org236f431}

\begin{enumerate}
\item 演化
\label{sec:org6e1802b}
...
\caption{\label{fig:org4cb961e}
演化图}
\end{figure}

\item 分类
\label{sec:org5abef54}
...
\section{比较}
\label{sec:org586c24c}

\begin{enumerate}
\item 共同点
\label{sec:org6fa5dc0}
...
\part{语音}
\label{sec:org40c11e9}

\chapter{字母}
\label{sec:orgd750090}

\section{字母表}
\label{sec:org6bda2b7}
\begin{enumerate}
\item Français
\label{sec:orgdd93dec}

\begin{longtabu} to 0.9\textwidth {XXX|XXX}
\caption{\label{tab:orgfcb3913}
法语字母表}
\\
\toprule
字母 & 名称 & 读音 & 字母 & 名称 & 读音\\
...
\item Español
\label{sec:org0aa86e9}

\begin{longtabu} to 0.9\textwidth {XXX|XXX}
\caption{\label{tab:org51cce3d}
西班牙语字母表}
\\
\toprule
字母 & 名称 & 读音 & 字母 & 名称 & 读音\\
...
\item Italiano
\label{sec:org3f1b5b2}

\begin{longtabu} to 0.9\textwidth {XXX|XXX}
\caption{\label{tab:org52c37c4}
意大利语字母表}
\\
\toprule
字母 & 名称 & 读音 & 字母 & 名称 & 读音\\
...
\section{音符表}
\label{sec:orge7aae3e}

\begin{longtabu} to 0.9\textwidth {X|X|X|X}
\caption{\label{tab:orgd93e227}
音符汇总表}
\\
\toprule
...
\chapter{发音}
\label{sec:org23fcd74}

\section{发音总表}
\label{sec:orgf7a5f5d}

\begin{longtabu} to 0.9\textwidth {l|X|X|X}
\caption{\label{tab:org5aa09ed}
元音汇总表}
\\
\toprule
音标 & 法语 & 西班牙语 & 意大利语\\
...
\section{发音规则}
\label{sec:org5590112}

\begin{enumerate}
\item Français
\label{sec:org3506833}

\begin{longtabu} to 0.9\textwidth {X|l|X}
\caption{\label{tab:org1bff88b}
法语元音表}
\\
\toprule
字母组合 & 读音 & 例词\\
...
\item Español
\label{sec:org3c9732d}

\begin{longtabu} to 0.9\textwidth {X|l|X}
\caption{\label{tab:org04e1345}
西班牙语元音表}
\\
\toprule
字母组合 & 读音 & 例词\\
...
\item Italiano
\label{sec:org4d12446}

\begin{longtabu} to 0.9\textwidth {X|l|X}
\caption{\label{tab:org3ddb460}
意大利语元音表}
\\
\toprule
字母组合 & 读音 & 例词\\
...
\part{语法}
\label{sec:org658451f}

\chapter{名词}
\label{sec:orgf8bf1b6}

\section{概述}
\label{sec:orgf7c007c}

\begin{enumerate}
\item Français
\label{sec:orgd9d4d22}

\item Español
\label{sec:org4bd0e12}

\item Italiano
\label{sec:org2c55ff6}
\end{enumerate}

\chapter{冠词}
\label{sec:orgdf3f082}

\section{概述}
\label{sec:org50758e5}

\begin{enumerate}
\item Français
\label{sec:orgb36c2b6}

\item Español
\label{sec:org4a7da64}

\item Italiano
\label{sec:org8f56d93}
\end{enumerate}

\chapter{代词}
\label{sec:orgec10f6b}

\section{人称代词}
\label{sec:orgf390890}

\begin{enumerate}
\item Français
\label{sec:org89ea2d4}

\item Español
\label{sec:org5f26ffd}

\item Italiano
\label{sec:org94784e0}
\end{enumerate}

\section{主有代词}
\label{sec:org059399e}

\begin{enumerate}
\item Français
\label{sec:org5987bfb}

\item Español
\label{sec:orgc460640}

\item Italiano
\label{sec:org15fca3e}
\end{enumerate}

\section{指示代词}
\label{sec:org12b86bd}

\begin{enumerate}
\item Français
\label{sec:org220532e}

\item Español
\label{sec:orgd1e30ca}

\item Italiano
\label{sec:orgadfd367}
\end{enumerate}

\chapter{形容词}
\label{sec:orgfb1766f}

\section{主有形容词}
\label{sec:orgb3ebfbb}

\begin{enumerate}
\item Français
\label{sec:org3d49566}

\item Español
\label{sec:org7aa7f40}

\item Italiano
\label{sec:org8c018aa}
\end{enumerate}

\section{指示形容词}
\label{sec:orgb0721d7}

\begin{enumerate}
\item Français
\label{sec:orgbf045e9}

\item Español
\label{sec:org3c47b6b}

\item Italiano
\label{sec:org3c4b03e}
\end{enumerate}

\chapter{数词}
\label{sec:orge5bcdee}

\section{概述}
\label{sec:orgb91a4a5}

\begin{enumerate}
\item Français
\label{sec:org5a2bcc5}

\item Español
\label{sec:org66831e5}

\item Italiano
\label{sec:org76868f7}
\end{enumerate}

\chapter{动词}
\label{sec:org29bf3ad}

\section{概述}
\label{sec:org953f888}

\begin{enumerate}
\item Français
\label{sec:org0758696}

\item Español
\label{sec:org679d373}

\item Italiano
\label{sec:org17f80ce}
\end{enumerate}

\chapter{副词}
\label{sec:orgb4ba987}

\section{概述}
\label{sec:org9e4ae2f}

\begin{enumerate}
\item Français
\label{sec:org16d30bd}

\item Español
\label{sec:org4545757}

\item Italiano
\label{sec:org7bc176d}
\end{enumerate}

\chapter{介词}
\label{sec:org1553793}

\section{概述}
\label{sec:orge9c2757}

\begin{enumerate}
\item Français
\label{sec:org1e0d00a}

\item Español
\label{sec:orgf069f9f}

\item Italiano
\label{sec:org56d0613}
\end{enumerate}

\part{句法}
\label{sec:orgc4d592e}

\newpage
\part{附录}
\label{sec:org330c46e}
