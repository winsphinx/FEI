...
\part{序言}
\label{sec:org204cc06}

\chapter{简介}
\label{sec:org4844758}
...
\caption{\label{fig:org5adbd9b}
分布图}
\end{figure}

\section{发展}
\label{sec:org739e524}

\begin{enumerate}
\item 演化
\label{sec:orgd868696}
...
\caption{\label{fig:org17d7c68}
演化图}
\end{figure}

\item 分支
\label{sec:org93f545c}
...
\section{比较}
\label{sec:orgdd24f87}

\begin{enumerate}
\item 共同点
\label{sec:org4b9c394}
...
\part{语音}
\label{sec:org75460ba}

\chapter{字母}
\label{sec:org818b277}

\section{字母表}
\label{sec:orgd9f259d}
\begin{enumerate}
\item Français
\label{sec:org12d510b}

\begin{longtabu} to 0.9\textwidth {XXX|XXX}
\caption{\label{tab:org7e03690}
法语字母表}
\\
\toprule
字母 & 名称 & 读音 & 字母 & 名称 & 读音\\
...
\item Español
\label{sec:orgfb26d85}

\begin{longtabu} to 0.9\textwidth {XXX|XXX}
\caption{\label{tab:org83c4a56}
西班牙语字母表}
\\
\toprule
字母 & 名称 & 读音 & 字母 & 名称 & 读音\\
...
\item Italiano
\label{sec:org12063a4}

\begin{longtabu} to 0.9\textwidth {XXX|XXX}
\caption{\label{tab:org879cd5b}
意大利语字母表}
\\
\toprule
字母 & 名称 & 读音 & 字母 & 名称 & 读音\\
...
\section{音符表}
\label{sec:org8a38975}

\begin{longtabu} to 0.9\textwidth {X|X|X|X}
\caption{\label{tab:orgbb4a536}
音符汇总表}
\\
\toprule
...
\chapter{发音}
\label{sec:org649b06e}

\section{发音总表}
\label{sec:orge8cd35e}

\begin{longtabu} to 0.9\textwidth {l|X|X|X}
\caption{\label{tab:org8b59b51}
元音汇总表}
\\
\toprule
音标 & 法语 & 西班牙语 & 意大利语\\
...
\section{发音规则}
\label{sec:orgee77142}

\begin{enumerate}
\item Français
\label{sec:org2714b45}

\begin{longtabu} to 0.9\textwidth {X|l|X}
\caption{\label{tab:org14bbebf}
法语元音表}
\\
\toprule
字母组合 & 读音 & 例词\\
...
\item Español
\label{sec:org8416979}

\begin{longtabu} to 0.9\textwidth {X|l|X}
\caption{\label{tab:org4527b45}
西班牙语元音表}
\\
\toprule
字母组合 & 读音 & 例词\\
...
\item Italiano
\label{sec:org10ace49}

\begin{longtabu} to 0.9\textwidth {X|l|X}
\caption{\label{tab:orgf97bd03}
意大利语元音表}
\\
\toprule
字母组合 & 读音 & 例词\\
...
\part{语法}
\label{sec:orgd1e9309}

\chapter{名词}
\label{sec:orged4860e}

\section{概述}
\label{sec:org04e802d}

\begin{enumerate}
\item Français
\label{sec:orgbb42f93}

\item Español
\label{sec:org3e0eaff}

\item Italiano
\label{sec:org5f7b549}
\end{enumerate}

\chapter{冠词}
\label{sec:orgf4bf2c8}

\section{概述}
\label{sec:orgefa3eef}

\begin{enumerate}
\item Français
\label{sec:org06154dc}

\item Español
\label{sec:org2526e2a}

\item Italiano
\label{sec:orgcc383c2}
\end{enumerate}

\chapter{代词}
\label{sec:orgd56c62d}

\section{人称代词}
\label{sec:org2723135}

\begin{enumerate}
\item Français
\label{sec:org2f842ae}

\item Español
\label{sec:org9e2761f}

\item Italiano
\label{sec:org5dbe917}
\end{enumerate}

\section{主有代词}
\label{sec:org40bdb5d}

\begin{enumerate}
\item Français
\label{sec:org3ce2b24}

\item Español
\label{sec:orge070700}

\item Italiano
\label{sec:orga2aa07d}
\end{enumerate}

\section{指示代词}
\label{sec:orgca20811}

\begin{enumerate}
\item Français
\label{sec:org1c4b881}

\item Español
\label{sec:org571e971}

\item Italiano
\label{sec:org5117bb8}
\end{enumerate}

\chapter{形容词}
\label{sec:org771cf85}

\section{主有形容词}
\label{sec:org97058ef}

\begin{enumerate}
\item Français
\label{sec:orgd4d3033}

\item Español
\label{sec:orgf7a1837}

\item Italiano
\label{sec:org89068b5}
\end{enumerate}

\section{指示形容词}
\label{sec:orga45484c}

\begin{enumerate}
\item Français
\label{sec:org1dd0907}

\item Español
\label{sec:orgb5c8fb3}

\item Italiano
\label{sec:org2fe692f}
\end{enumerate}

\chapter{数词}
\label{sec:org0bda544}

\section{概述}
\label{sec:org58c3aad}

\begin{enumerate}
\item Français
\label{sec:org9c72baf}

\item Español
\label{sec:org90cf5c8}

\item Italiano
\label{sec:org87883be}
\end{enumerate}

\chapter{动词}
\label{sec:orgd7b771d}

\section{概述}
\label{sec:orgc03e79f}

\begin{enumerate}
\item Français
\label{sec:org4bdb329}

\item Español
\label{sec:orgba29153}

\item Italiano
\label{sec:org3cc7e2d}
\end{enumerate}

\chapter{副词}
\label{sec:org88d2ada}

\section{概述}
\label{sec:org41264d6}

\begin{enumerate}
\item Français
\label{sec:orgd7e8e1c}

\item Español
\label{sec:orgc98e68f}

\item Italiano
\label{sec:org70a3f8c}
\end{enumerate}

\chapter{介词}
\label{sec:org21644fd}

\section{概述}
\label{sec:orgc65db01}

\begin{enumerate}
\item Français
\label{sec:org4e5e635}

\item Español
\label{sec:org0dcd8eb}

\item Italiano
\label{sec:org509d68a}
\end{enumerate}

\part{句法}
\label{sec:orgbb504d0}

\newpage
\part{附录}
\label{sec:orgfa31390}
