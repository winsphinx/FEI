...
\part{序言}
\label{sec:orged8737f}

\chapter{简介}
\label{sec:org2aca685}
...
\section{发展}
\label{sec:org8c1010c}

\begin{enumerate}
\item 演化
\label{sec:org0313098}
...
\section{比较}
\label{sec:org78c8a62}

\begin{enumerate}
\item 共同点
\label{sec:org5664de1}
...
\part{语音}
\label{sec:orgefde47b}

\chapter{字母}
\label{sec:org5c8f053}

\section{字母表}
\label{sec:orgea8b52a}

\begin{enumerate}
\item Français
\label{sec:org8fcbc5a}
...
\chapter{发音}
\label{sec:org8ca9416}

\section{发音总表}
\label{sec:org4e77b6f}
...
\section{发音规则}
\label{sec:org4184f55}

\begin{enumerate}
\item Français
\label{sec:org6c2d86d}
...
\part{语法}
\label{sec:orgfbf2ca3}

\chapter{名词}
\label{sec:org7452e3c}

\section{名词}
\label{sec:org8ce57b3}

名词有性（阳性、阴性）、数（单数、复数）的变化，基本上不再有格的变化。

\begin{enumerate}
\item Français
\label{sec:org159350c}

\item Español
\label{sec:orgb6957ce}

\item Italiano
\label{sec:orgf5fde51}
...
\chapter{冠词}
\label{sec:org732324a}

\section{冠词}
\label{sec:orgeb5829c}

冠词有性（阳性、阴性）、数（单数、复数）的变化，要和其限定的名词做性数配合。

\begin{enumerate}
\item Français
\label{sec:orgfcd67ae}
...
\chapter{代词}
\label{sec:org74147e4}

\section{代词}
\label{sec:org985d8f0}

代词有性（阳性、阴性）、数（单数、复数）的变化。

\begin{enumerate}
\item Français
\label{sec:orge386cb5}

\item Español
\label{sec:org5de7522}

\item Italiano
\label{sec:org7fce4ac}
...
\chapter{形容词}
\label{sec:orgbd099d6}

\section{形容词}
\label{sec:orgbc5dd9b}

形容词有性（阳性、阴性）、数（单数、复数）的变化，要和其限定的名词做性数配合。

\begin{enumerate}
\item Français
\label{sec:org354f255}

\item Español
\label{sec:org5f8fc0e}

\item Italiano
\label{sec:orgfbdd3d0}
...
\chapter{数词}
\label{sec:org1a18bd2}

\section{数词}
\label{sec:org52e7165}

数词分基数词和序数词。基数词“1”需要和计数的名词的性一致。序数词要与被计数名词保持性数一致。

\begin{enumerate}
\item Français
\label{sec:org19b2562}

\item Español
\label{sec:orgff4a2c9}

\item Italiano
\label{sec:org18a9e87}
...
\chapter{动词}
\label{sec:org0b538bf}

\section{动词}
\label{sec:orgce67c3a}

动词有时（现在时、将来时、过去时）、式（直陈式、命令式、虚拟式、条件式）、态（主动态、被动态）、分词（现在分词、过去分词）等各种变化。

\begin{enumerate}
\item Français
\label{sec:orgf600e57}

\item Español
\label{sec:org4128cd1}

\item Italiano
\label{sec:orgd7da62a}
...
\begin{itemize}
\item Parlerei con te se tu volessi.（我像和你谈谈，要是你愿意。）
\end{itemize}
...
\chapter{副词}
\label{sec:org5d9c78e}

\section{副词}
\label{sec:orga3caf60}

\begin{enumerate}
\item Français
\label{sec:org486f05b}

\item Español
\label{sec:orgb2e1a6c}

\item Italiano
\label{sec:orgb617562}
\end{enumerate}

\chapter{介词}
\label{sec:org1466080}

\section{介词}
\label{sec:orgbf09f98}

\begin{enumerate}
\item Français
\label{sec:orgdbc408a}

\item Español
\label{sec:org3061748}

\item Italiano
\label{sec:org1e535c3}
\end{enumerate}

\part{句法}
\label{sec:org21f7fd5}

\newpage
\part{附录}
\label{sec:org63979a5}
